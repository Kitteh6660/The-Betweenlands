...
public class SurfaceAmbienceType extends AmbienceType {
	...
	public boolean isActive() {
		return !EventDenseFog.isDenseFog(this.getPlayer().world) && !EventWinter.isFroooosty(this.getPlayer().world) && this.getPlayer().getY() > WorldProviderBetweenlands.CAVE_START - 15;
	}
