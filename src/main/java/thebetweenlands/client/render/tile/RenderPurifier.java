...
public class RenderPurifier<T extends TileEntity> extends TileEntityRenderer<TileEntityPurifier> {
	...
	public void render(TileEntityPurifier te, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
		...
		if (amount >= 100) {
			...
			buffer.pos(0.1F, 0.0F, 0.1F).tex(waterIcon.getU0(), waterIcon.getV0()).color(0.2F, 0.6F, 0.4F, 1.0F).endVertex();
			buffer.pos(0.1F, 0.0F, 0.9F).tex(waterIcon.getU0(), waterIcon.getV1()).color(0.2F, 0.6F, 0.4F, 1.0F).endVertex();
			buffer.pos(0.9F, 0.0F, 0.9F).tex(waterIcon.getU1(), waterIcon.getV1()).color(0.2F, 0.6F, 0.4F, 1.0F).endVertex();
			buffer.pos(0.9F, 0.0F, 0.1F).tex(waterIcon.getU1(), waterIcon.getV0()).color(0.2F, 0.6F, 0.4F, 1.0F).endVertex();
			tesselator.draw();
