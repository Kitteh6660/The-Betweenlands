...
public class ParticleWeedwoodLeaf extends Particle implements IParticleSpriteReceiver {
	...
	public static final class Factory extends ParticleFactory<Factory, ParticleWeedwoodLeaf> {
		public Factory() {
			super(ParticleWeedwoodLeaf.class, ParticleTextureStitcher.create(ParticleWeedwoodLeaf.class, new ResourceLocation("thebetweenlands:particle/leaf")).setSplitAnimations(true));
		}

		@Override
		public ParticleWeedwoodLeaf createParticle(ImmutableParticleArgs args) {
			return new ParticleWeedwoodLeaf(args.world, args.x, args.y, args.z, args.motionX, args.motionY, args.motionZ, args.data.getInt(0), args.scale);
		}
