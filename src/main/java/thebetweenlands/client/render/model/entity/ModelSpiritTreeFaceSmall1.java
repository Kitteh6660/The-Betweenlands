 ...
 */
public class ModelSpiritTreeFaceSmall1 extends Model {
    ...
    public ModelSpiritTreeFaceSmall1() {
        ...
        this.sidethingy_2.setPos(-2.98F, 0.0F, 3.0F);
        ...
        this.head_base.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.brow_leftpiece_1.setPos(5.0F, 0.0F, -0.02F);
        ...
        this.sidethingy_1.setPos(2.98F, 0.0F, 3.0F);
        ...
        this.brow_left.setPos(1.5F, -3.0F, 0.02F);
        ...
        this.brow_right.setPos(-1.5F, -3.0F, 0.02F);
        ...
        this.brow_rightpiece_1.setPos(-5.0F, 0.0F, -0.02F);
    ...
    public void renderToBuffer(MatrixStack pMatrixStack, IVertexBuilder pBuffer, int pPackedLight, int pPackedOverlay, float pRed, float pGreen, float pBlue, float pAlpha) {  
        this.head_base.render(pMatrixStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
    }
