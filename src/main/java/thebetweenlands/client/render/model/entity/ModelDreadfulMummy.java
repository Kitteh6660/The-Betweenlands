...
public class ModelDreadfulMummy extends MowzieModelBase {
	...
	public ModelDreadfulMummy() {
		...
		this.aestheticleg1b.setPos(0.0F, 8.0F, 0.0F);
		...
		this.spiderleg3.setPos(-0.5F, 0.0F, 0.0F);
		...
		this.teeth_lower.setPos(0.0F, 0.0F, -0.7F);
		this.teeth_lower.addBox(-2.5F, -1.0F, -5.0F, 5, 1, 5, 0.0F);
		this.legleft1 = new MowzieModelRenderer(this, 18, 43);
		this.legleft1.setPos(3.1819604078071397F, 4.8204065100680396F, -1.072154330214967F);
		...
		this.spiderleg1.setPos(-0.5F, 1.0F, 0.5F);
		...
		this.aestheticleg1.setPos(-1.0F, -0.5F, 1.5F);
		...
		this.head1.setPos(-0.09F, -2.89F, 0.88F);
		...
		this.frontLeftArmJoint.setPos(2.0F, -2.0F, -2.0F);
		this.frontLeftArmJoint.addBox(0.0F, 0.0F, 0.0F, 0, 0, 0, 0.0F);
		this.sexybutt = new MowzieModelRenderer(this, 0, 31);
		this.sexybutt.setPos(-0.0035067239080670137F, 8.998236163378392F, -0.005657502465559849F);
		...
		this.tongue3.setPos(0.0F, 0.0F, -3.0F);
		...
		this.neck.setPos(0.37784292855481877F, -1.635799711236193F, -3.8335259815816247F);
		...
		this.legright1.setPos(-2.8180395921928603F, 4.8204065100680396F, -1.072154330214967F);
		...
		this.shoulderright.setPos(0.0F, 2.5000000000000004F, -0.49999999999999867F);
		...
		this.armright1.setPos(-4.1825438415682195F, -2.157008565237252F, 1.6478898909504247F);
		...
		this.spiderleg2.setPos(0.5F, 1.0F, 0.5F);
		...
		this.spiderleg3a.setPos(0.0F, 8.0F, 0.0F);
		...
		this.head2.setPos(-0.07F, 0.9F, -1.09F);
		...
		this.aestheticleg2.setPos(1.0F, -1.0F, 0.0F);
		...
		this.tongue4.setPos(0.0F, 1.0F, -3.0F);
		...
		this.teeth_upper.setPos(-0.06908394214624095F, 0.9027403801674749F, -2.7864102424740955F);
		this.teeth_upper.addBox(-3.0F, 0.0F, -5.0F, 6, 1, 5, 0.0F);
		this.aestheticleg2a = new MowzieModelRenderer(this, 91, 40);
		this.aestheticleg2a.setPos(0.0F, 6.0F, -1.0F);
		...
		this.spiderleg1b.setPos(0.0F, 18.0F, -1.0F);
		...
		this.jaw.setPos(0.0F, 2.0000000000000004F, -2.0F);
		...
		this.tongue5.setPos(0.0F, 0.0F, -2.0F);
		...
		this.spiderleg2a.setPos(0.0F, 8.0F, 0.0F);
		...
		this.body_base.setPos(0.002791314540518036F, 0.4909944110609308F, 0.5047597093941052F);
		...
		this.tongue2.setPos(0.0F, -1.0F, -2.0F);
		...
		this.tongue1.setPos(-0.06908394214624095F, 3.402740380167474F, -3.086410242474096F);
		...
		this.shoulderleft.setPos(0.0F, 2.5000000000000004F, -0.49999999999999867F);
		...
		this.backLeftLegJoint.setPos(2.0F, 0.0F, 1.5F);
		this.backLeftLegJoint.addBox(0.0F, 0.0F, 0.0F, 0, 0, 0, 0.0F);
		this.armleft1 = new MowzieModelRenderer(this, 27, 43);
		this.armleft1.setPos(4.190142388244066F, -2.1605578702972807F, 1.6460954039271694F);
		...
		this.aestheticleg1a.setPos(0.0F, 6.0F, -1.0F);
		...
		this.legright2.setPos(-1.0F, 8.0F, -1.0F);
		...
		this.armleft2.setPos(0.0F, 9.0F, 0.0F);
		...
		this.spiderleg2b.setPos(0.0F, 16.0F, -1.0F);
		...
		this.spiderleg3b.setPos(0.0F, 14.0F, -1.0F);
	...
	public void renderToBuffer(MatrixStack pMatrixStack, IVertexBuilder pBuffer, int pPackedLight, int pPackedOverlay, float pRed, float pGreen, float pBlue, float pAlpha) { 
		...
		this.shoulders.render(pMatrixStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
	}
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
		...
		float partialTicks = f2 - entity.tickCount;
		
		float spawningProgress = mummy.getSpawningProgress(partialTicks);
		body_base.xRot -= Math.min((1 - spawningProgress) * 1.5f, 0.7f);
		head1.xRot -= Math.min((1 - spawningProgress) * 2.0f, 1.5f);
		
		legleft1.xRot += (1 - spawningProgress) * 0.85f;
		legright1.xRot += (1 - spawningProgress) * 0.85f;
		...
		if(mummy.deathTicks > 0) {
			double contractAngle = this.body_base.xRot - this.body_base.xRot / (mummy.deathTicks / 120.0D + 1.0D);
			this.body_base.xRot -= contractAngle;
			...
			if(mummy.deathTicks > 60) {
				...
				this.body_base.xRot = rotateAngle;
			}
		}
	...
	@Override
	public void setLivingAnimations(LivingEntity entity, float f3, float f4, float delta) {
		...
		if (mummy.currentEatPrey != null) {
			...
			tongue2.xRot += Math.PI;
			tongue3.xRot += Math.PI;
			tongue4.xRot += Math.PI;
			tongue5.xRot += Math.PI;
			armleft1.xRot -= 1.2;
		} else {
