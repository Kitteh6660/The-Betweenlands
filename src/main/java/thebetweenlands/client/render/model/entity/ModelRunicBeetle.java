 ...
 */
public class ModelRunicBeetle extends Model {
    ...
    public ModelRunicBeetle() {
        ...
        this.thorax_main.setPos(0.0F, 21.0F, 0.0F);
    ...
    public void renderToBuffer(MatrixStack pMatrixStack, IVertexBuilder pBuffer, int pPackedLight, int pPackedOverlay, float pRed, float pGreen, float pBlue, float pAlpha) {  
        this.thorax_main.render(pMatrixStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
    }
