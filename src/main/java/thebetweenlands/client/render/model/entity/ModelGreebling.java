...
public class ModelGreebling extends MowzieModelBase{
    ...
    public ModelGreebling() {
        ...
        this.jaw_0.setPos(0.0F, 0.04549010195178495F, -1.4979263506025928F);
        ...
        this.earleft_0.setPos(1.0F, -2.5F, -0.59F);
        ...
        this.earright_0.setPos(-1.0F, -2.5F, -0.59F);
        ...
        this.legright1_0.setPos(-1.3F, 0.867466694522502F, -0.9149770530750317F);
        ...
        this.strokestick_0.setPos(0.0F, 4.0F, 0.0F);
        ...
        this.armleft1_0.setPos(2.5F, -2.122938627842288F, -0.784733536128615F);
        ...
        this.armleft2_0.setPos(0.0F, 3.5F, 0.0F);
        ...
        this.endpiece1_0.setPos(0.0F, -7.0F, 0.0F);
        ...
        this.head2_0.setPos(0.0F, 0.0F, 0.0F);
        ...
        this.legleft1_0.setPos(1.3F, 0.867466694522502F, -0.9149770530750317F);
        ...
        this.head1_0.setPos(0.0F, -3.8311339463882743F, -0.9674967227287707F);
        ...
        this.luteneck_0.setPos(0.017376167048784863F, 0.29556824894909506F, -0.330517345185515F);
        ...
        this.armright1_0.setPos(-2.5F, -2.122938627842288F, -0.784733536128615F);
        ...
        this.lutebase_0.setPos(-0.7622866342321437F, 3.1200327646462362F, -1.21631341944674F);
        ...
        this.legleft2_0.setPos(0.0F, 2.5F, 0.0F);
        ...
        this.chest_0.setPos(0.0F, -2.965801266869104F, -0.27582661303015055F);
        ...
        this.root_0.setPos(0.0F, 24.0F, -5.5F);
        this.root_0.addBox(0.0F, -24.0F, 5.5F, 0, 0, 0, 0.0F);
        this.body_base_0 = new MowzieModelRenderer(this, 0, 9);
        this.body_base_0.setPos(0.0F, -1.1384599901460248F, 0.5872213733837306F);
        ...
        this.armright2_0.setPos(0.0F, 3.5F, 0.0F);
        ...
        this.nose_0.setPos(0.0F, 0.0F, -3.0F);
        ...
        this.legright2_0.setPos(0.0F, 2.5F, 0.0F);
        ...
        this.earright_1.setPos(-1.0F, -2.48F, -0.32F);
        ...
        this.beard_1.setPos(0.0F, 1.0F, -2.0F);
        ...
        this.panflute4_1.setPos(1.0F, 0.0F, 0.0F);
        ...
        this.legleft1_1.setPos(1.3F, 0.5777565139606047F, 0.16185614160758632F);
        ...
        this.cup_1.setPos(5.5F, 24.0F, -2.0F);
        ...
        this.nose_1.setPos(0.0F, 0.0F, -3.0F);
        ...
        this.armright2_1.setPos(0.0F, 3.5F, 0.0F);
        ...
        this.legright1_1.setPos(-1.3F, 0.5777565139606047F, 0.16185614160758632F);
        ...
        this.panflute3_1.setPos(1.0F, 0.0F, 0.0F);
        ...
        this.earleft_1.setPos(1.0F, -2.48F, -0.32F);
        ...
        this.panflute1_1.setPos(0.3091571662794066F, 4.451192104343287F, -0.5676794810700461F);
        ...
        this.armleft2_1.setPos(0.0F, 3.5F, 0.0F);
        ...
        this.jaw_1.setPos(0.0F, 0.0F, -1.0F);
        ...
        this.handle_1.setPos(0.0F, 0.0F, 1.0F);
        this.handle_1.addBox(0.0F, -3.0F, 0.0F, 0, 3, 2, 0.0F);
        this.armleft1_1 = new MowzieModelRenderer(this, 25, 0);
        this.armleft1_1.setPos(2.5F, -1.6999999999999957F, -0.5000000000000008F);
        ...
        this.chest_1.setPos(0.0F, -3.7748866854558005F, 0.5002304588572539F);
        ...
        this.legright2_1.setPos(0.0F, 2.5F, 0.0F);
        ...
        this.legleft2_1.setPos(0.0F, 2.5F, 0.0F);
        ...
        this.body_base_1.setPos(0.0F, -1.1F, -1.5F);
        ...
        this.armright1_1.setPos(-2.5F, -1.6999999999999957F, -0.5000000000000008F);
    ...
    public void setLivingAnimations(LivingEntity entity, float swing, float speed, float partialRenderTicks) {
        EntityGreebling greebling = (EntityGreebling) entity;
        setToInitPose();
        float frame = greebling.tickCount + partialRenderTicks;
        ...
        body_base_1.yRot += Math.pow(5* disappearFrame/8f, 1.4);

        body_base_0.rotationPointY -= 16 * Math.pow(disappearFrame/8f, 1.5);
        body_base_0.yRot += Math.pow(5* disappearFrame/8f, 1.4);
    }
}
