...
public class ModelBarrishee extends MowzieModelBase {
	    ...
	    public ModelBarrishee() {
	        ...
	        finger_left_mid_1.setPos(0.0F, -1.5F, -5.0F);
	        ...
	        finger_right_mid_2.setPos(0.0F, 0.0F, -3.0F);
	        ...
	        finger_left_thumb.setPos(-4.0F, 0.0F, -0.5F);
	        ...
	        greeble_back.setPos(0.0F, -3.0F, 11.0F);
	        ...
	        shoulder_right.setPos(-7.0F, -1.5F, 2.0F);
	        ...
	        headress_right2.setPos(0.0F, -7.0F, -2.0F);
	        ...
	        finger_right_outer_1.setPos(-1.5F, -1.5F, -4.0F);
	        ...
	        headress_left3.setPos(6.0F, 0.0F, 0.0F);
	        ...
	        finger_right_thumb.setPos(4.0F, 0.0F, -0.5F);
	        ...
	        finger_left_outer_2.setPos(0.0F, 0.0F, -3.0F);
	        ...
	        headress_right1.setPos(0.0F, 1.0F, -9.0F);
	        ...
	        finger_left_inner_2.setPos(0.0F, 0.0F, -3.0F);
	        ...
	        cog1_10.setPos(5.0F, 0.0F, -0.01F);
	        ...
	        arm_left_2.setPos(4.0F, 0.0F, 0.0F);
	        ...
	        cog2_10.setPos(-0.01F, 0.0F, -4.0F);
	        ...
	        cog2_11.setPos(-0.01F, 0.0F, -4.0F);
	        ...
	        finger_left_outer.setPos(4.0F, 0.0F, -6.0F);
	        ...
	        finger_right_inner.setPos(-4.0F, 0.0F, -6.0F);
	        ...
	        hand_right_1.setPos(0.0F, 12.0F, 0.0F);
	        ...
	        finger_right_inner_2.setPos(0.0F, 0.0F, -3.0F);
	        ...
	        headress_left2.setPos(0.0F, -7.0F, -2.0F);
	        ...
	        cog1_12.setPos(5.0F, 0.0F, -0.01F);
	        ...
	        finger_right_mid_1.setPos(0.0F, -1.5F, -5.0F);
	        ...
	        chest_right.setPos(0.0F, 1.0F, 0.0F);
	        ...
	        greeble1_2.setPos(0.0F, -4.0F, 0.0F);
	        ...
	        cog1_11.setPos(5.0F, 0.0F, -0.01F);
	        ...
	        shoulder_left.setPos(7.0F, -1.5F, 2.0F);
	        ...
	        finger_left_outer_1.setPos(-1.5F, -1.5F, -4.0F);
	        ...
	        greeble2_1.setPos(-4.5F, -3.0F, 8.5F);
	        ...
	        arm_right_2.setPos(-4.0F, 0.0F, 0.0F);
	        ...
	        finger_right_outer_2.setPos(0.0F, 0.0F, -3.0F);
	        ...
	        finger_right_inner_1.setPos(1.5F, -1.5F, -4.0F);
	        ...
	        finger_left_thumb_2.setPos(0.0F, 0.0F, -3.0F);
	        ...
	        finger_left_mid.setPos(0.0F, 0.0F, -7.0F);
	        ...
	        greeble2_2.setPos(0.0F, -4.0F, 0.0F);
	        ...
	        finger_right_mid.setPos(0.0F, 0.0F, -7.0F);
	        ...
	        finger_right_outer.setPos(4.0F, 0.0F, -6.0F);
	        ...
	        finger_left_thumb_1.setPos(1.5F, -1.5F, -4.0F);
	        ...
	        headress_left1.setPos(0.0F, 1.0F, -9.0F);
	        ...
	        cog2_12.setPos(-0.01F, 0.0F, -4.0F);
	        ...
	        headress_right3.setPos(-6.0F, 0.0F, 0.0F);
	        ...
	        finger_left_inner_1.setPos(1.5F, -1.5F, -4.0F);
	        ...
	        chest_left.setPos(0.0F, 1.0F, 0.0F);
	        ...
	        hand_left_1.setPos(0.0F, 12.0F, 0.0F);
	        ...
	        greeble1_1.setPos(4.5F, -3.0F, 8.5F);
    ...
    public void render(Entity entity, float limbSwing, float limbSwingAngle, float entityTickTime, float yRot, float xRot, float scale) {
        head_main.yRot = (float) Math.toRadians(yRot);
	...
	public void setLivingAnimations(LivingEntity entity, float limbSwing, float limbSwingAngle, float partialRenderTicks) {
		...
		float flap = MathHelper.sin((barrishee.tickCount + partialRenderTicks) * 0.6F) * 0.8F;
		float flap2 = MathHelper.sin((barrishee.tickCount + partialRenderTicks) * 0.3F) * 0.8F;
		
		cog1_1.zRot = 0F + animation;
		cog1_1.xRot = 0 + animation3;
		
		if ((barrishee.standingAngle > 0)) {
			base_rotation_bit.xRot = convertDegtoRad(-65F) + (convertDegtoRad(65F) * standingAngle);
			neck.xRot = convertDegtoRad(60F) - (convertDegtoRad(60F) * standingAngle);
			head_main.xRot = convertDegtoRad(5F) - (convertDegtoRad(5F) * standingAngle);
			belly_1.xRot = convertDegtoRad(30F) - (convertDegtoRad(70F) * standingAngle);
		}
		...
		if (barrishee.isScreaming() && barrishee.getScreamTimer() >= 20 && barrishee.getScreamTimer() <= 30) {
			...
			base_rotation_bit.xRot = convertDegtoRad(0F) - (convertDegtoRad(10F) * fudge * 0.1F);
			belly_1.xRot = convertDegtoRad(-40F) + (convertDegtoRad(10F) * fudge * 0.1F);
			neck.xRot = convertDegtoRad(0F) - (convertDegtoRad(45F) * fudge * 0.1F);
			head_main.xRot = convertDegtoRad(0F) + (convertDegtoRad(25F) * fudge * 0.1F);

			jaw_back.xRot = convertDegtoRad(0F) + (convertDegtoRad(10F) * fudge * 0.1F);
			jaw1.xRot = convertDegtoRad(20F) + (convertDegtoRad(45F) * fudge * 0.1F);

			shoulder_right.xRot = convertDegtoRad(0F) + (convertDegtoRad(30F) * fudge * 0.1F);
			shoulder_right.zRot = convertDegtoRad(-25F) + (convertDegtoRad(-5F) * fudge * 0.1F);

			shoulder_left.xRot = convertDegtoRad(0F) + (convertDegtoRad(30F) * fudge * 0.1F);
			shoulder_left.zRot = convertDegtoRad(25F) + (convertDegtoRad(5F) * fudge * 0.1F);

			hand_right_1.xRot = convertDegtoRad(25F) - (convertDegtoRad(20F) * fudge * 0.1F);
			hand_left_1.xRot = convertDegtoRad(25F) - (convertDegtoRad(20F) * fudge * 0.1F);
		}
		
		if (barrishee.isScreaming() && barrishee.getScreamTimer() > 30 && barrishee.getScreamTimer() < 40) {
			base_rotation_bit.xRot = convertDegtoRad(-10F);
			belly_1.xRot = convertDegtoRad(-30F);
			neck.xRot = convertDegtoRad(-45F);

			jaw_back.xRot = convertDegtoRad(10F);
			jaw1.xRot = convertDegtoRad(65F);

			shoulder_right.xRot = convertDegtoRad(30F);
			shoulder_right.zRot = convertDegtoRad(-30F);

			shoulder_left.xRot = convertDegtoRad(30F);
			shoulder_left.zRot = convertDegtoRad(30F);

			hand_right_1.xRot = convertDegtoRad(5F);
			hand_left_1.xRot = convertDegtoRad(5F);
			
			head_main.zRot = 0F + animation2 * 0.25F + flap * 0.25F;
		}

		if (barrishee.isScreaming() && barrishee.getScreamTimer() >= 40) {
			float fudge = barrishee.getScreamTimer() - 40 + partialRenderTicks;
			
			base_rotation_bit.xRot = convertDegtoRad(-10F) + (convertDegtoRad(10F) * fudge * 0.1F);
			belly_1.xRot = convertDegtoRad(-30F) - (convertDegtoRad(10F) * fudge * 0.1F);
			neck.xRot = convertDegtoRad(-45F) + (convertDegtoRad(45F) * fudge * 0.1F);
			head_main.xRot = convertDegtoRad(25F) - (convertDegtoRad(25F) * fudge * 0.1F);

			jaw_back.xRot = convertDegtoRad(10F) - (convertDegtoRad(10F) * fudge * 0.1F);
			jaw1.xRot = convertDegtoRad(65F) - (convertDegtoRad(45F) * fudge * 0.1F);

			shoulder_right.xRot = convertDegtoRad(30F) - (convertDegtoRad(30F) * fudge * 0.1F);
			shoulder_right.zRot = convertDegtoRad(-30F) + (convertDegtoRad(5F) * fudge * 0.1F);

			shoulder_left.xRot = convertDegtoRad(30F) - (convertDegtoRad(30F) * fudge * 0.1F);
			shoulder_left.zRot = convertDegtoRad(30F) - (convertDegtoRad(5F) * fudge * 0.1F);

			hand_right_1.xRot = convertDegtoRad(5F) + (convertDegtoRad(20F) * fudge * 0.1F);
			hand_left_1.xRot = convertDegtoRad(5F) + (convertDegtoRad(20F) * fudge * 0.1F);
		}
		...
		if (!barrishee.isAmbushSpawn() && !barrishee.isScreaming() && !barrishee.isSlamming() || barrishee.isAmbushSpawn() && barrishee.standingAngle == 1 && !barrishee.isScreaming() && !barrishee.isSlamming()) {
			cogbeam.xRot = 0F + animation;
			neck.xRot = 0F - flap2 * 0.0625F;
			head_main.xRot = 0F + flap2 * 0.0625F;
			head_main.zRot = 0F + animation2 * 0.25F;
			jaw_back.xRot = 0F + - flap2 * 0.125F;
			jaw1.xRot = convertDegtoRad(20F) - flap2 * 0.0625F;

			shoulder_left.xRot = 0F + animation2 * 0.5F;
			shoulder_right.xRot = 0F - animation2 * 0.5F;
			arm_left_2.xRot = 0F + animation2;
			arm_right_2.xRot = 0F - animation2;

			hand_left_1.xRot = 0.36425021489121656F - shoulder_left.xRot - arm_left_2.xRot - animation2 * 0.5F;
			hand_right_1.xRot = 0.36425021489121656F - shoulder_right.xRot - arm_right_2.xRot + animation2 * 0.5F;

			finger_left_inner.xRot = -0.17453292519943295F + animation2;
			finger_left_inner_1.xRot = 0.7853981633974483F + animation2;
			finger_left_inner_2.xRot = -0.5235987755982988F - animation2;

			finger_left_mid.xRot = -0.17453292519943295F + animation2;
			finger_left_mid_1.xRot = 0.7853981633974483F + animation2;
			finger_left_mid_2.xRot = -0.5235987755982988F - animation2;

			finger_left_outer.xRot = -0.17453292519943295F + animation2;
			finger_left_outer_1.xRot = 0.7853981633974483F + animation2;
			finger_left_outer_2.xRot = -0.5235987755982988F - animation2;

			finger_right_inner.xRot = -0.17453292519943295F - animation2;
			finger_right_inner_1.xRot = 0.7853981633974483F - animation2;
			finger_right_inner_2.xRot = -0.5235987755982988F + animation2;

			finger_right_mid.xRot = -0.17453292519943295F - animation2;
			finger_right_mid_1.xRot = 0.7853981633974483F - animation2;
			finger_right_mid_2.xRot = -0.5235987755982988F + animation2;

			finger_right_outer.xRot = -0.17453292519943295F - animation2;
			finger_right_outer_1.xRot = 0.7853981633974483F - animation2;
			finger_right_outer_2.xRot = -0.5235987755982988F + animation2;

			base_rotation_bit.xRot = 0F - animation2 * 0.125F;
			base_rotation_bit.zRot = 0F - animation2 * 0.125F;

			belly_1.xRot = -0.6457718232379019F + animation2 * 0.125F;
			belly_1.zRot = -0.08726646259971647F + animation2 * 0.125F;
		}
	}
