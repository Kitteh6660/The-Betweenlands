 ...
 */
public class ModelLargeSludgeWorm extends Model {
	...
	private static class HeartModelRenderer extends ModelRenderer {
		...
		public void render(float scale) {
			...
			if(this.entity != null) {
				float x = (this.entity.tickCount + this.tickOffset + this.partialTicks) * 0.15F;
	...
	public ModelLargeSludgeWorm() {
		...
		this.spine5.setPos(0.0F, 0.0F, 2.0F);
		...
		this.artery5.setPos(-0.5F, -1.0F, 2.0F);
		...
		this.lowerjaw_left.setPos(1.0F, 1.5F, -1.0F);
		...
		this.spine3.setPos(0.0F, -1.0F, 0.0F);
		...
		this.artery3.setPos(0.0F, 0.0F, 2.0F);
		...
		this.spine7.setPos(0.0F, 0.0F, 2.0F);
		...
		this.endpiece_spine10.setPos(0.0F, 16.0F, 30.0F);
		...
		this.spine6.setPos(0.0F, 0.0F, 4.0F);
		...
		this.heart1.setPos(0.0F, -1.0F, 1.6F);
		...
		this.artery7.setPos(0.0F, 0.0F, 2.0F);
		...
		this.tailbone1.setPos(0.0F, -1.0F, 3.0F);
		...
		this.artery1.setPos(0.0F, 0.0F, -2.0F);
		...
		this.spine8.setPos(0.0F, 0.0F, 2.1F);
		...
		this.midpiece_spine4.setPos(0.0F, 16.0F, 11.0F);
		...
		this.heart2.setPos(-1.0F, 0.0F, 0.0F);
		...
		this.lowerjaw_right.setPos(-1.0F, 1.5F, -1.0F);
		...
		this.artery4.setPos(1.0F, 0.0F, 0.5F);
		...
		this.sludge_mid3.setPos(0.0F, 0.0F, 0.0F);
	...
	public void renderHead(EntityLargeSludgeWorm worm, int frame, float wibbleStrength, float partialTicks, boolean renderSolids) {
		...
		this.lowerjaw_left.xRot = 0.5918411493512771F - 0.2F + jawWibbleLeft * 0.8F;
		this.lowerjaw_left.yRot = -0.18203784098300857F - jawWibbleRight * 0.2F;

		this.lowerjaw_right.xRot = 0.5918411493512771F - 0.2F + jawWibbleRight * 0.8F;
		this.lowerjaw_right.yRot = 0.18203784098300857F + jawWibbleRight * 0.2F;

		this.head1.xRot = -0.045553093477052F - jawWibbleLeft * 0.1F;
