...
@OnlyIn(Dist.CLIENT)
public class ModelDecayPitTargetShield extends Model {
    ...
    public ModelDecayPitTargetShield() {
        ...
        lowerplate_left.setPos(3.0F, 0.0F, 0.0F);
        ...
        lowerplate_mid.setPos(0.0F, 1.5F, -2.5F);
        ...
        base_right.setPos(-3.0F, 0.0F, -3.0F);
        ...
        upperplate_right.setPos(-3.0F, 0.0F, 0.0F);
        ...
        base_left.setPos(3.0F, 0.0F, -3.0F);
        ...
        upperplate_mid.setPos(0.0F, -1.5F, -2.5F);
        ...
        lowerplate_right.setPos(-3.0F, 0.0F, 0.0F);
