 ...
 */
public class ModelGreeblingCorpse extends Model {
	...
	public ModelGreeblingCorpse() {
		...
		this.ear_left.setPos(1.0F, -3.5F, -1.0F);
		...
		this.jaw.setPos(1.5F, -1.0F, -2.0F);
		...
		this.arm_right1.setPos(-2.0F, -2.5F, -2.0F);
		...
		this.head1.setPos(0.0F, -2.5F, -1.0F);
		...
		this.ribcage.setPos(1.0F, 0.0F, 0.0F);
		...
		this.ear_right.setPos(-1.0F, -3.5F, -1.0F);
		...
		this.body_base.setPos(0.0F, 23.5F, -2.0F);
		...
		this.arm_right2.setPos(0.51F, 3.5F, 0.5F);
