...
public class ModelTermite extends MowzieModelBase {
    ...
    public ModelTermite() {
        ...
        this.sensorleft1.setPos(2.0F, -2.0F, -2.0F);
        ...
        this.legleft_m2.setPos(0.0F, 3.5F, 0.0F);
        ...
        this.body_base.setPos(0.0F, 21.0F, -3.5F);
        ...
        this.body1.setPos(0.0F, 0.0F, 2.0F);
        ...
        this.legleft_b2.setPos(0.0F, 3.5F, 0.0F);
        ...
        this.body4.setPos(0.0F, 0.0F, 4.0F);
        ...
        this.body3.setPos(-0.01F, 0.0F, 4.0F);
        ...
        this.legleft_f2.setPos(0.0F, 3.5F, 0.0F);
        ...
        this.legleft_b1.setPos(2.5F, 20.0F, -2.5F);
        ...
        this.legright_b2.setPos(0.0F, 3.5F, 0.0F);
        ...
        this.head.setPos(0.0F, 18.0F, -3.5F);
        ...
        this.leafcrane1.setPos(0.0F, -2.0F, 0.0F);
        ...
        this.sensorleft1b.setPos(0.0F, 0.0F, -3.0F);
        ...
        this.jawmid.setPos(0.0F, -2.0F, -4.5F);
        ...
        this.legright_m2.setPos(0.0F, 3.5F, 0.0F);
        ...
        this.legright_f2.setPos(0.0F, 3.5F, 0.0F);
        ...
        this.legleft_m1.setPos(2.5F, 20.1F, -3.5F);
        ...
        this.leafcrane1b.setPos(0.0F, 0.0F, 3.0F);
        ...
        this.sensorright1b.setPos(0.0F, 0.0F, -3.0F);
        ...
        this.legright_f1.setPos(-2.5F, 20.0F, -4.5F);
        ...
        this.sensorright1.setPos(-2.0F, -2.0F, -2.0F);
        ...
        this.body2.setPos(0.01F, 0.0F, 4.0F);
        ...
        this.jawleft.setPos(1.0F, 0.0F, -4.5F);
        ...
        this.jawright.setPos(-1.0F, 0.0F, -4.5F);
        ...
        this.legright_b1.setPos(-2.5F, 20.0F, -2.5F);
        ...
        this.legleft_f1.setPos(2.5F, 20.0F, -4.5F);
        ...
        this.legright_m1.setPos(-2.5F, 20.1F, -3.5F);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAngle, float entityTickTime, float yRot, float xRot, float unitPixel, Entity entity) {
        ...
        legright_f1.zRot = movement + 1.95F;
        legright_m1.zRot = -movement + 1.95F;
        legright_b1.zRot = movement + 1.95F;
        legleft_f1.zRot = movement - 1.95F;
        legleft_m1.zRot = -movement - 1.95F;
        legleft_b1.zRot = movement - 1.95F;

        legright_f1.yRot = movement;
        legright_m1.yRot = -movement;
        legright_b1.yRot = movement;
        legleft_f1.yRot = movement;
        legleft_m1.yRot = -movement;
        legleft_b1.yRot = movement;
    }
...
//        swing(jawleft, 2, 0.3f * mandibleControl, false, 0, 0, frame, 1);
        jawleft.yRot -= 1 * mandibleControl * Math.cos(2 * frame);
        jawright.yRot += 1 * mandibleControl * Math.cos(2 * frame);
        jawmid.xRot -= 1 * mandibleControl * Math.cos(2 * frame);
    }
}
