...
@OnlyIn(Dist.CLIENT)
public class ModelSiltCrab extends Model {
	...
	public ModelSiltCrab() {
		...
		legleft_b1.setPos(2.0F, 21.0F, 2.0F);
		...
		clawbase2.setPos(0.0F, 3.0F, 0.0F);
		...
		clawpoint1.setPos(0.0F, 3.0F, 0.0F);
		...
		snapper1.setPos(-1.0F, 0.5F, 0.0F);
		...
		clawpoint2.setPos(0.0F, 3.0F, 0.0F);
		...
		legright_f2.setPos(-3.5F, 0.0F, 0.0F);
		...
		legright_m1.setPos(-2.0F, 21.0F, 1.0F);
		...
		legleft_b2.setPos(2.5F, 0.0F, 0.0F);
		...
		clawtop1.setPos(1.0F, 0.5F, 0.0F);
		...
		legleft_f2.setPos(3.5F, 0.0F, 0.0F);
		...
		legright_m2.setPos(-3.5F, 0.0F, 0.0F);
		...
		legright_b2.setPos(-2.5F, 0.0F, 0.0F);
		...
		clawtop2.setPos(-1.0F, 0.5F, 0.0F);
		...
		armleft1.setPos(2.0F, 20.7F, -0.5F);
		...
		legleft_f1.setPos(2.0F, 21.0F, 0.0F);
		...
		armright1.setPos(-2.0F, 20.7F, -0.5F);
		...
		legleft_m2.setPos(3.5F, 0.0F, 0.0F);
		...
		clawbase1.setPos(0.0F, 3.0F, 0.0F);
		...
		legleft_m1.setPos(2.0F, 21.0F, 1.0F);
		...
		snapper2.setPos(1.0F, 0.5F, 0.0F);
		...
		legright_f1.setPos(-2.0F, 21.0F, 0.0F);
		...
		body_base.setPos(0.0F, 18.5F, -1.0F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAngle, float entityTickTime, float yRot, float xRot, float unitPixel, Entity entity) {
		...
		armright1.xRot = -movement * 0.2F -1.5025539530419183F;
		armleft1.xRot = movement * 0.2F -1.5025539530419183F;
		legright_f1.zRot = movement;
		legright_m1.zRot = -movement;
		legright_b1.zRot = movement;
		legleft_f1.zRot = movement;
		legleft_m1.zRot = -movement;
		legleft_b1.zRot = movement;
