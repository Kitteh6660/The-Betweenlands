...
public class ModelDragonFly extends MowzieModelBase {
    ...
    private void init() {
        ...
        jawleft.setPos(0.0F, 18.0F, -9.0F);
        ...
        eyeleft.setPos(0.0F, 18.0F, -9.0F);
        ...
        back.setPos(0.0F, 18.200000762939453F, -3.0F);
        ...
        antennaleft.setPos(0.0F, 18.0F, -9.0F);
        ...
        antennaright.setPos(0.0F, 18.0F, -9.0F);
        ...
        eyeright.setPos(0.0F, 18.0F, -9.0F);
        ...
        jawright.setPos(0.0F, 18.0F, -9.0F);
        ...
        wingright2.setPos(0.5F, 16.5F, 0);
        ...
        rightback1.setPos(-1.0F, 20.0F, -5.0F);
        ...
        rightback2.setPos(-1.0F, 20.0F, -5.0F);
        ...
        leftback1.setPos(1.0F, 20.0F, -5.0F);
        ...
        leftback2.setPos(1.0F, 20.0F, -5.0F);
        ...
        rightmid1.setPos(-1.0F, 20.0F, -6.0F);
        ...
        rightmid2.setPos(-1.0F, 20.0F, -6.0F);
        ...
        leftmid1.setPos(1.0F, 20.0F, -6.0F);
        ...
        leftmid2.setPos(1.0F, 20.0F, -6.0F);
        ...
        rightfront1.setPos(-1.0F, 20.0F, -7.0F);
        ...
        rightfront2.setPos(-1.0F, 20.0F, -7.0F);
        ...
        leftfront1.setPos(1.0F, 20.0F, -7.0F);
        ...
        leftfront2.setPos(1.0F, 20.0F, -7.0F);
    ...
    @Override
    public void render(Entity entity, float swing, float speed, float tickCount, float yaw, float pitch, float scale) {
        torso.render(scale);
        back.render(scale);
        tail1.render(scale);
        head1.render(scale);
    ...
    public void setLivingAnimations(LivingEntity entity, float swing, float speed, float partialRenderTicks) {
        ...
        wingright1.xRot = 0.1745329F;
        wingleft1.xRot = 0.1745329F;
        wingright2.xRot = -0.1745329F;
        wingleft2.xRot = -0.1745329F;

        if (dragonFly.onGround) {
        	float flap = MathHelper.sin((dragonFly.tickCount + partialRenderTicks) * 0.08F) * 0.05F;
        	 wingright1.zRot = -1.570796F - flap;
             wingleft1.zRot = 1.570796F + flap;
             wingright2.zRot = -1.570796F - flap;
             wingleft2.zRot = 1.570796F + flap;
        }
        if (dragonFly.isFlying()) {
        	float flap = MathHelper.sin((dragonFly.tickCount + partialRenderTicks) * 1.6F) * 0.3F;
            wingright1.zRot = -1.570796F - flap;
            wingleft1.zRot = 1.570796F + flap;
            wingright2.zRot = -1.570796F - flap;
            wingleft2.zRot = 1.570796F + flap;
