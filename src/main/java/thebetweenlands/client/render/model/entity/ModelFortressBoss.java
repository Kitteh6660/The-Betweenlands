 ...
 */
public class ModelFortressBoss extends Model {
	...
	public ModelFortressBoss() {
		...
		this.cap2.setPos(0.0F, 0.0F, 5.5F);
		...
		this.eye.setPos(0.0F, -7.0F, -4.0F);
		...
		this.cape5.setPos(0.0F, -4.0F, 0.0F);
		...
		this.cape6.setPos(0.0F, -8.0F, 0.0F);
		...
		this.cap1.setPos(0.0F, -18.12F, -4.09F);
		...
		this.cape1.setPos(0.0F, -0.8F, -5.7F);
		...
		this.chainpiece3.setPos(5.0F, 0.0F, 0.0F);
		...
		this.cape3.setPos(0.0F, -6.0F, 0.0F);
		...
		this.cape2.setPos(0.0F, 0.0F, 0.0F);
		...
		this.cape4.setPos(0.0F, -4.0F, 0.0F);
		...
		this.chainpiece2.setPos(6.0F, 8.0F, 0.0F);
		...
		this.chainpiece1.setPos(-6.0F, 8.0F, 0.0F);
