...
@OnlyIn(Dist.CLIENT)
public class ModelEmberlingShaman extends Model {
   ...
   ModelRenderer charstick3;
    ...
    public ModelEmberlingShaman() {
        ...
        charstick2.setPos(15.0F, 1.0F, 0.0F);
        ...
        body_base.setPos(0.0F, -7.0F, -6.0F);
        ...
        base_rotation.setPos(0.0F, 16.3F, 0.0F);
        ...
        charstick1.setPos(6.0F, 3.5F, -1.5F);
        ...
        hindleg_left1.setPos(3.0F, 5.0F, 2.0F);
        ...
        charstick3.setPos(2.0F, 0.0F, 0.0F);
        ...
        hindleg_right1.setPos(-3.0F, 5.0F, 2.0F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAngle, float entityTickTime, float yRot, float xRot, float unitPixel, Entity entity) {
		...
		EntityEmberlingShaman emberling = (EntityEmberlingShaman) entity;
		...
		head_main.xRot = 0.18203784098300857F + headx + emberling.animationTicks;
	}
	...
	public void setLivingAnimations(LivingEntity entity, float limbSwing, float limbSwingAngle, float partialRenderTicks) {
		...
		hindleg_left1.xRot = 0.5009094953223726F + animation * 2F;
		hindleg_right1.xRot = 0.5009094953223726F - animation * 2F;

		hindleg_left2.xRot = 0.31869712141416456F;
		hindleg_right2.xRot = 0.31869712141416456F;
		
		arm_right1.xRot = -0.4553564018453205F - animation;
		arm_right1.yRot = -0.136659280431156F - animation * 2F;
		arm_right1.zRot = 1.3658946726107624F + emberling.smoothedAngle(partialRenderTicks);

		arm_left1.xRot = 0.36425021489121656F - animation * 2F;
		arm_left2.xRot = -1.1383037381507017F + animation;
		arm_left1.yRot = -0.27314402793711257F + animation;
		arm_left1.zRot = -0.22759093446006054F - emberling.smoothedAngle(partialRenderTicks);
		
		body_base.xRot = -0.18203784098300857F - animation * 0.5F + flap * 0.025F - emberling.smoothedAngle(partialRenderTicks) * 0.125F;

		body3.xRot = -0.22759093446006054F + animation * 0.5F - flap * 0.05F + emberling.smoothedAngle(partialRenderTicks) * 0.125F;
