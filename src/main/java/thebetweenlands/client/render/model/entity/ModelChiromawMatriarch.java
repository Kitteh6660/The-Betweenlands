...
public class ModelChiromawMatriarch extends MowzieModelBase {
	...
	public ModelChiromawMatriarch() {
		...
		arm_right1b.setPos(0.01F, 3.0F, 2.0F);
		...
		foot_claw_left1.setPos(0.0F, 5.0F, -2.0F);
		...
		vertebrate3.setPos(0.0F, 0.0F, -6.0F);
		...
		arm_right1a.setPos(-4.5F, 2.0F, -6.5F);
		...
		crest_mid1b.setPos(0.0F, 0.0F, 3.0F);
		...
		teeth_upper_right.setPos(-4.0F, 0.0F, -6.0F);
		...
		crest_right1b.setPos(0.0F, 0.0F, 4.0F);
		...
		crest_mid1a.setPos(0.0F, -5.0F, -3.0F);
		...
		body_base.setPos(0.0F, 11.0F, 7.0F);
		...
		claw_right1b.setPos(0.01F, 3.0F, -2.0F);
		...
		canine_lower_right1b.setPos(0.0F, -2.0F, 0.0F);
		...
		claw_left1b.setPos(-0.01F, 3.0F, -2.0F);
		...
		vertebrate1.setPos(0.0F, 0.0F, -7.0F);
		...
		canine_upper_left1b.setPos(0.0F, 1.0F, 0.0F);
		...
		arm_right1c.setPos(0.01F, 12.0F, 0.0F);
		...
		vertebrate2.setPos(0.0F, 0.0F, -3.0F);
		...
		teeth_lower_right.setPos(-3.0F, 0.0F, -3.0F);
		...
		claw_right1a.setPos(0.01F, 18.0F, 0.0F);
		...
		leg_right1c.setPos(-1.5F, 5.0F, 3.0F);
		...
		claw_left1a.setPos(-0.01F, 18.0F, 0.0F);
		...
		crest_left1b.setPos(0.0F, 0.0F, 4.0F);
		...
		crest_left1a.setPos(2.5F, -4.0F, -3.5F);
		...
		wingflap_left2.setPos(2.0F, 0.0F, 0.0F);
		...
		crest_left2.setPos(4.0F, 0.0F, -2.0F);
		...
		leg_left1b.setPos(-0.01F, 5.0F, 2.0F);
		...
		canine_lower_left1b.setPos(0.0F, -2.0F, 0.0F);
		...
		arm_left1a.setPos(4.5F, 2.0F, -6.5F);
		...
		arm_left1b.setPos(-0.01F, 3.0F, 2.0F);
		...
		crest_right2.setPos(-4.0F, 0.0F, -2.0F);
		...
		leg_right1b.setPos(0.01F, 5.0F, 2.0F);
		...
		canine_upper_left1a.setPos(4.0F, 0.0F, -9.0F);
		...
		canine_lower_right1a.setPos(-3.0F, 0.0F, -6.0F);
		...
		arm_left1c.setPos(-0.01F, 12.0F, 0.0F);
		...
		crest_right1a.setPos(-2.5F, -4.0F, -3.5F);
		...
		canine_upper_right1b.setPos(0.0F, 1.0F, 0.0F);
		...
		teeth_upper_mid.setPos(0.0F, 0.0F, -9.0F);
		...
		teeth_upper_left.setPos(4.0F, 0.0F, -6.0F);
		...
		foot_claw_right1.setPos(0.0F, 5.0F, -2.0F);
		...
		wingflap_right1.setPos(-2.0F, 0.0F, 0.0F);
		...
		leg_left1a.setPos(3.0F, 1.5F, 4.5F);
		...
		canine_lower_left1a.setPos(3.0F, 0.0F, -6.0F);
		...
		leg_left1c.setPos(1.5F, 5.0F, 3.0F);
		...
		leg_right1a.setPos(-3.0F, 1.5F, 4.5F);
		...
		teeth_lower_left.setPos(3.0F, 0.0F, -3.0F);
		...
		wingflap_right2.setPos(-2.0F, 0.0F, 0.0F);
		...
		wingflap_left1.setPos(2.0F, 0.0F, 0.0F);
		...
		canine_upper_right1a.setPos(-4.0F, 0.0F, -9.0F);
    ...
    public void setLivingAnimations(LivingEntity entity, float swing, float speed, float partialRenderTicks) {
        ...
        blender.addState(model -> {
        	model.setToInitPose();
        	jaw.xRot = 0.8651597102135892F;
        	head1.xRot = 0.136659280431156F;
        	crest_left1a.xRot -= 0.25 * featherControl * Math.cos(0.5 * frame);
        	crest_right1a.xRot -= 0.25 * featherControl * Math.cos(0.5 * frame);
        	crest_mid1a.xRot -= 0.25 * featherControl * Math.cos(0.5 * frame);
        ...
        class FlyingPose {
        	public void apply(ModelChiromawMatriarch model, float globalSpeed, float globalDegree, float rippleSpeed) {
        		head1.xRot = -0.398132F;
				if (!chiromaw.isBeingRidden()) {
					leg_right1a.xRot = 0.7285004297824331F;
					leg_left1a.xRot = 0.7285004297824331F;
					leg_right1b.xRot = 1.367539130330308F;
					leg_left1b.xRot = 1.367539130330308F;
				}
        ...
        blender.addState(model -> {
        	model.setToInitPose();
	 		...
	 		model.arm_right1a.xRot = 0.3553564018453205F;
	 		model.arm_left1a.xRot = 0.3553564018453205F;
