...
@OnlyIn(Dist.CLIENT)
public class ModelWight extends Model {
    ...
    public ModelWight() {
        ...
        chest_right.setPos(0.0F, 0.0F, 0.0F);
        ...
        chest_left.setPos(0.0F, 0.0F, 0.0F);
        ...
        headpieceleft2.setPos(0.0F, 0.0F, 0.0F);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAngle, float entityTickTime, float yRot, float xRot, float unitPixel, Entity entity) {
        ...
        armright.xRot = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAngle;
        armleft.xRot = -MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAngle;
        legleft.xRot = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAngle;
        legright.xRot = -MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAngle;
    }
