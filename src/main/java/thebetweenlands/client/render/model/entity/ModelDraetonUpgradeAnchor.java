 ...
 */
public class ModelDraetonUpgradeAnchor extends Model {
    ...
    public ModelDraetonUpgradeAnchor() {
        ...
        this.anchor_hook1b.setPos(-0.02F, 3.0F, 0.0F);
        ...
        this.anchor_hook4e.setPos(0.0F, 3.0F, 2.0F);
        ...
        this.anchor_hook2e.setPos(0.0F, 3.0F, 2.0F);
        ...
        this.anchor_hook4d.setPos(0.01F, 3.0F, 0.0F);
        ...
        this.anchor_hook2a.setPos(-1.0F, 8.0F, 0.0F);
        ...
        this.anchor_hook2d.setPos(0.01F, 3.0F, 0.0F);
        ...
        this.anchor_hook1d.setPos(0.01F, 3.0F, 0.0F);
        ...
        this.anchor_hook2c.setPos(-0.01F, 3.0F, 0.0F);
        ...
        this.anchor_hook3a.setPos(0.0F, 8.0F, 1.0F);
        ...
        this.anchor_hook3c.setPos(-0.01F, 3.0F, 0.0F);
        ...
        this.anchor_hook4b.setPos(-0.02F, 3.0F, 0.0F);
        ...
        this.anchor_rope.setPos(0.0F, 1.0F, 0.0F);
        ...
        this.anchor_hook4a.setPos(1.0F, 8.0F, 0.0F);
        ...
        this.anchor_hook3b.setPos(-0.02F, 3.0F, 0.0F);
        ...
        this.anchor_hook3d.setPos(0.01F, 3.0F, 0.0F);
        ...
        this.anchor_hook1a.setPos(0.0F, 8.0F, -1.0F);
        ...
        this.anchor_hook1c.setPos(-0.01F, 3.0F, 0.0F);
        ...
        this.anchor_hook1e.setPos(0.0F, 3.0F, 2.0F);
        ...
        this.anchor_hook4c.setPos(-0.01F, 3.0F, 0.0F);
    ...
    public void renderToBuffer(MatrixStack pMatrixStack, IVertexBuilder pBuffer, int pPackedLight, int pPackedOverlay, float pRed, float pGreen, float pBlue, float pAlpha) {  
        this.anchor_main.render(pMatrixStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
    }
