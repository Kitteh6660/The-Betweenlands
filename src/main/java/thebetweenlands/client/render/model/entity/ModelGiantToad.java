...
public class ModelGiantToad extends MowzieModelBase {
    ...
    public ModelGiantToad() {
        ...
        this.leg_back_right2.setPos(-2.0F, 9.0F, 5.0F);
        ...
        this.eyebrow_right4.setPos(0.0F, 0.0F, -4.0F);
        ...
        this.eyebrow_left2.setPos(0.0F, 0.0F, 4.0F);
        ...
        this.foot_front_right2.setPos(2.0F, 2.0F, 2.0F);
        ...
        this.beardthing_right3.setPos(-3.0F, 0.0F, -4.0F);
        ...
        this.toe_back_right4.setPos(2.0F, 0.0F, -6.0F);
        ...
        this.leg_back_right1.setPos(-8.0F, 4.0F, 16.0F);
        ...
        this.sexy_toad_butt.setPos(0.0F, -2.0F, 16.0F);
        ...
        this.snout2.setPos(0.0F, 0.0F, -6.0F);
        ...
        this.foot_front_left2.setPos(-2.0F, 2.0F, 2.0F);
        ...
        this.toe_back_right1.setPos(1.0F, 0.0F, -10.0F);
        ...
        this.foot_back_right2.setPos(2.0F, 3.0F, 2.0F);
        ...
        this.foot_front_left1.setPos(2.0F, 6.0F, -2.0F);
        ...
        this.beardthing_left2.setPos(0.0F, 3.0F, 0.0F);
        ...
        this.foot_back_left1.setPos(2.0F, 8.0F, 2.0F);
        ...
        this.eyebrow_left3.setPos(3.0F, 0.0F, -3.0F);
        ...
        this.foot_back_left2.setPos(-2.0F, 3.0F, 2.0F);
        ...
        this.toe_back_left1.setPos(-1.0F, 0.0F, -10.0F);
        ...
        this.beardthing_left1.setPos(4.0F, 10.0F, -4.0F);
        ...
        this.leg_back_left1.setPos(8.0F, 4.0F, 16.0F);
        ...
        this.head_base.setPos(0.0F, 0.0F, -6.0F);
        ...
        this.snout1.setPos(0.0F, 0.0F, -6.0F);
        ...
        this.toe_front_left2.setPos(0.5F, -2.0F, -5.0F);
        ...
        this.toe_front_right2.setPos(-0.5F, -2.0F, -5.0F);
        ...
        this.leg_front_left2.setPos(2.0F, 7.0F, 1.0F);
        ...
        this.leg_front_right2.setPos(-2.0F, 7.0F, 1.0F);
        ...
        this.tubbyneck.setPos(0.0F, -2.0F, -2.0F);
        ...
        this.leg_back_left2.setPos(2.0F, 9.0F, 5.0F);
        ...
        this.foot_back_right1.setPos(-2.0F, 8.0F, 2.0F);
        ...
        this.lower_jaw.setPos(0.0F, 10.0F, -6.0F);
        ...
        this.eyeleft1.setPos(5.0F, 1.5F, -3.0F);
        ...
        this.toe_front_left4.setPos(-2.0F, -2.0F, -2.5F);
        ...
        this.eyebrow_left4.setPos(0.0F, 0.0F, -4.0F);
        ...
        this.toe_front_right1.setPos(1.0F, -2.0F, -5.0F);
        ...
        this.body_base.setPos(0.0F, 6.3F, -2.0F);
        ...
        this.eyebrow_left1.setPos(4.0F, 1.0F, -3.0F);
        ...
        this.leg_front_left1.setPos(7.5F, 6.0F, -1.0F);
        ...
        this.toe_front_left3.setPos(2.0F, -2.0F, -5.0F);
        ...
        this.foot_front_right1.setPos(-2.0F, 6.0F, -2.0F);
        ...
        this.beardthing_right2.setPos(0.0F, 3.0F, 0.0F);
        ...
        this.eyebrow_right3.setPos(-3.0F, 0.0F, -3.0F);
        ...
        this.eyebrow_right2.setPos(0.0F, 0.0F, 4.0F);
        ...
        this.beardthing_left3.setPos(3.0F, 0.0F, -4.0F);
        ...
        this.eyeright1.setPos(-5.0F, 1.5F, -3.0F);
        ...
        this.toe_back_right2.setPos(-0.5F, 0.0F, -10.0F);
        ...
        this.beardthing_right1.setPos(-4.0F, 10.0F, -4.0F);
        ...
        this.eyebrow_right1.setPos(-4.0F, 1.0F, -3.0F);
        ...
        this.toe_front_right4.setPos(2.0F, -2.0F, -2.5F);
        ...
        this.toe_front_right3.setPos(-2.0F, -2.0F, -5.0F);
        ...
        this.toe_back_left4.setPos(-2.0F, 0.0F, -6.0F);
        ...
        this.toe_front_left1.setPos(-1.0F, -2.0F, -5.0F);
        ...
        this.leg_front_right1.setPos(-7.5F, 6.0F, -1.0F);
        ...
        this.toe_back_left3.setPos(2.0F, 0.0F, -10.0F);
        ...
        this.toe_back_right3.setPos(-2.0F, 0.0F, -10.0F);
        ...
        this.toe_back_left2.setPos(0.5F, 0.0F, -10.0F);
    ...
    @Override
    public void setLivingAnimations(LivingEntity entity, float yaw, float pitch, float partialRenderTicks) {
        EntityGiantToad toad = (EntityGiantToad) entity;
        setToInitPose();
        float frame = toad.tickCount + partialRenderTicks;
        ...
        body_base.xRot += 0.25 * inWaterProgress;
        head_base.xRot -= 0.4 * inWaterProgress;
        head_base.rotationPointZ += 2.5F * inWaterProgress;
        leg_back_left1.xRot += 0.8 * inWaterProgress;
        leg_back_right1.xRot += 0.8 * inWaterProgress;
        leg_front_left1.xRot -= 0.6 * inWaterProgress;
        leg_front_right1.xRot -= 0.6 * inWaterProgress;
        leg_front_left2.yRot -= 0.6 * inWaterProgress;
        leg_front_right2.yRot += 0.6 * inWaterProgress;


        //Swimming
        if (swimProgress - 0.05F > leapingProgress) {
            body_base.xRot += 0.2 * swimProgress;

            leg_back_left1.yRot += -0.1F * swimProgress;
            leg_back_right1.yRot += 0.1F * swimProgress;
            leg_back_left1.xRot += 1.8 * swimProgress;
            leg_back_right1.xRot += 1.8 * swimProgress;
            leg_back_left1.zRot -= 1.2 * swimProgress;
            leg_back_right1.zRot += 1.2 * swimProgress;
            foot_back_left1.xRot += 2 * swimProgress;
            foot_back_right1.xRot += 2 * swimProgress;
            leg_back_left2.xRot -= 2 * swimProgress;
            leg_back_right2.xRot -= 2 * swimProgress;

            leg_front_left1.xRot += 0.8 * 2 * swimProgress;
            leg_front_left1.zRot += 0.4 * swimProgress;
            leg_front_left2.yRot -= 1.8 * 2 * swimProgress;
            foot_front_left1.xRot += 1 * swimProgress;
            foot_front_left1.yRot += 1.5 * swimProgress;
            foot_front_left1.zRot -= 1.5 * swimProgress;

            leg_front_right1.xRot += 0.8 * 2 * swimProgress;
            leg_front_right1.zRot -= 0.4 * swimProgress;
            leg_front_right2.yRot += 1.8 * 2 * swimProgress;
            foot_front_right1.xRot += 1 * swimProgress;
            foot_front_right1.yRot -= 1.5 * swimProgress;
            foot_front_right1.zRot += 1.5 * swimProgress;
        } else {
            //Jumping
            body_base.xRot += 0.2 * leapingProgress;


            leg_back_left1.xRot += 2.3 * leapingProgress;
            leg_back_right1.xRot += 2.3 * leapingProgress;
            leg_back_left1.zRot -= 0.2 * leapingProgress;
            leg_back_right1.zRot += 0.2 * leapingProgress;
            foot_back_left1.xRot += 2 * leapingProgress;
            foot_back_right1.xRot += 2 * leapingProgress;
            leg_back_left2.xRot -= 2 * leapingProgress;
            leg_back_right2.xRot -= 2 * leapingProgress;

            leg_front_left1.xRot -= 0.8 * leapingProgress;
            leg_front_right1.xRot -= 0.8 * leapingProgress;
            leg_front_left2.zRot -= 0.8 * leapingProgress;
            leg_front_right2.zRot += 0.8 * leapingProgress;
        }
    }
}
