 ...
 */
public class ModelDraetonUpgradeCrafting extends Model {
    ...
    public ModelDraetonUpgradeCrafting() {
        ...
        this.support2c.setPos(-4.0F, 0.0F, 0.0F);
        ...
        this.thonghandle2.setPos(-0.5F, 2.5F, 0.0F);
        ...
        this.thonghandle1.setPos(7.5F, 1.0F, -5.0F);
        ...
        this.support2a.setPos(8.0F, 1.0F, -3.0F);
        ...
        this.support1c.setPos(-4.0F, 0.0F, 0.0F);
        ...
        this.hammerhandle.setPos(3.0F, 1.0F, -5.0F);
        ...
        this.crafting_mainrotation.setPos(0.0F, 0.0F, 0.0F);
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    	if(entityIn instanceof EntityDraeton) {
    		...
    		this.hammerhandle.zRot = -0.136659280431156F - roll;
    		this.thonghandle1.zRot = -0.27314402793711257F - roll;
    		this.sawhandle.zRot = -0.136659280431156F - roll;
    	} else {
    		this.hammerhandle.zRot = -0.136659280431156F;
    		this.thonghandle1.zRot = -0.27314402793711257F;
    		this.sawhandle.zRot = -0.136659280431156F;
    	}
