...
@OnlyIn(Dist.CLIENT)
public class ModelFrog extends Model {
    ModelRenderer torso;
    ModelRenderer head;
    ...
    public ModelFrog() {
        ...
        legfrontleft2.setPos(2.0F, 20.0F, 0.0F);
        ...
        legbackleft1.setPos(2.0F, 22.0F, 3.0F);
        ...
        legbackleft2.setPos(1.0F, 0.3F, 2.0F);
        ...
        legbackright2.setPos(-1.0F, 0.3F, 2.0F);
        ...
        legbackright1.setPos(-2.0F, 22.0F, 3.0F);
        ...
        legfrontright2.setPos(-2.0F, 20.0F, 0.0F);
        ...
        legfrontright1.setPos(-2.0F, 20.0F, 0.0F);
        ...
        legfrontleft1.setPos(2.0F, 20.0F, 0.0F);
    ...
    public void setRotationAngles(float limbSwing, float prevLimbSwing, float entityTickTime, float yRot, float xRot, float unitPixel, Entity entity) {
        head.yRot = yRot / (180F / (float) Math.PI);
        head.xRot = xRot / (180F / (float) Math.PI) - 0.07435719668865202F + (float) Math.sin(entityTickTime / 8.0F) / 15.0F;
    }
    ...
    public void setLivingAnimations(LivingEntity entity, float swing, float speed, float partialRenderTicks) {
        ...
        legbackleft1.xRot = -0.296705972839036F;
        legbackright1.xRot = -0.296705972839036F;
        legbackleft2.xRot = 0.45378560551852565F;
        legbackright2.xRot = 0.45378560551852565F;
        legfrontleft1.zRot = -0.3717860877513886F;
        legfrontright1.zRot = 0.37178999185562134F;
        legfrontleft2.zRot = 0.5948578119277954F;
        legfrontright2.zRot = -0.5948606133460999F;
        
        if (!frog.isInWater()) {
            //Idle animation
            this.torso.xRot = -0.55F - (float) (Math.sin((entity.tickCount + partialRenderTicks) / 10.0F) + 1) / 35.0F;
            this.torso.rotationPointY = 19 + (float) Math.sin((entity.tickCount + partialRenderTicks) / 8.0F) / 15.0F;
            ...
            //Idle animation
            this.torso.xRot = -0.1F - (float) (Math.sin((entity.tickCount + partialRenderTicks) / 10.0F) + 1) / 35.0F;

            //Water bobbing animation
            this.torso.rotationPointY = 19 + (float) Math.sin((entity.tickCount + partialRenderTicks) / 8.0F) / 2.0F;
            this.legbackleft1.rotationPointY = 21 + (float) Math.sin((entity.tickCount + partialRenderTicks) / 8.0F) / 2.0F;
            this.legbackright1.rotationPointY = 21 + (float) Math.sin((entity.tickCount + partialRenderTicks) / 8.0F) / 2.0F;
            this.head.rotationPointY = 19 + (float) Math.sin((entity.tickCount + partialRenderTicks) / 8.0F) / 2.0F;
            this.legfrontleft1.rotationPointY = 20 + (float) Math.sin((entity.tickCount + partialRenderTicks) / 8.0F) / 2.0F;
            this.legfrontleft2.rotationPointY = 20 + (float) Math.sin((entity.tickCount + partialRenderTicks) / 8.0F) / 2.0F;
            this.legfrontright1.rotationPointY = 20 + (float) Math.sin((entity.tickCount + partialRenderTicks) / 8.0F) / 2.0F;
            this.legfrontright2.rotationPointY = 20 + (float) Math.sin((entity.tickCount + partialRenderTicks) / 8.0F) / 2.0F;
        ...
        if (!frog.onGround || frog.jumpAnimationTicks > 0) {
            if (frog.jumpAnimationTicks > 0 && frog.jumpAnimationTicks <= 7) {
                legbackleft1.xRot = -0.296705972839036F + 0.15F * leapProgress;
                legbackright1.xRot = -0.296705972839036F + 0.15F * leapProgress;
                legbackleft2.xRot = 0.45378560551852565F + 0.2F * leapProgress;
                legbackright2.xRot = 0.45378560551852565F + 0.2F * leapProgress;

                legfrontleft1.zRot = -0.3717860877513886F - 0.15F * leapProgress;
                legfrontright1.zRot = 0.37178999185562134F + 0.15F * leapProgress;
                legfrontleft2.zRot = 0.5948578119277954F - 0.15F * leapProgress;
                legfrontright2.zRot = -0.5948606133460999F + 0.15F * leapProgress;
            }
            if (frog.jumpAnimationTicks > 7 && frog.jumpAnimationTicks <= 14) {
                legbackleft1.xRot = -0.296705972839036F + 1.05F - 0.075F * leapProgress;
                legbackright1.xRot = -0.296705972839036F + 1.05F - 0.075F * leapProgress;
                legbackleft2.xRot = 0.45378560551852565F + 1.4F - 0.1F * leapProgress;
                legbackright2.xRot = 0.45378560551852565F + 1.4F - 0.1F * leapProgress;

                legfrontleft1.zRot = -0.3717860877513886F - 1.05F + 0.075F * leapProgress;
                legfrontright1.zRot = 0.37178999185562134F + 1.05F - 0.075F * leapProgress;
                legfrontleft2.zRot = 0.5948578119277954F - 1.05F + 0.075F * leapProgress;
                legfrontright2.zRot = -0.5948606133460999F + 1.05F - 0.075F * leapProgress;
            }
        }
    }
}
