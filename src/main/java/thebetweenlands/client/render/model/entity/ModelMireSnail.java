...
@OnlyIn(Dist.CLIENT)
public class ModelMireSnail extends Model {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAngle, float entityTickTime, float yRot, float xRot, float unitPixel, Entity entity) {
        ...
        sensor1.xRot = MathHelper.cos(limbSwing * 1F + (float) Math.PI) * 1.5F * limbSwingAngle + 0.5F;
        sensor2.xRot = MathHelper.cos(limbSwing * 1F) * 1.5F * limbSwingAngle + 0.5F;
        sensor1.yRot = MathHelper.cos(limbSwing * 1F + (float) Math.PI) * 1.5F * limbSwingAngle - 0.2F;
        sensor2.yRot = MathHelper.cos(limbSwing * 1F) * 1.5F * limbSwingAngle + 0.2F;
    }
