...
@OnlyIn(Dist.CLIENT)
public class ModelCryptCrawler extends Model {
    ...
    public ModelCryptCrawler() {
        ...
        leg_front_right1[0].setPos(-4.0F, 2.0F, -6.0F);
        ...
        tinyurn1[0].setPos(2.0F, 6.0F, 3.0F);
        ...
        leg_front_left2[0].setPos(0.0F, 5.0F, 2.0F);
        ...
        leg_back_right1[0].setPos(-4.0F, 0.0F, 7.0F);
        ...
        body_main[0].setPos(0.0F, 12.0F, 0.0F);
        ...
        lowerjaw[0].setPos(0.0F, 4.0F, -3.8F);
        ...
        leg_back_left3[0].setPos(0.0F, 6.0F, 0.0F);
        ...
        tinyurn2[0].setPos(-1.0F, 6.0F, 3.0F);
        ...
        leg_back_right3[0].setPos(0.0F, 6.0F, 0.0F);
        ...
        ear_right[0].setPos(-3.0F, 0.0F, 0.0F);
        ...
        leg_back_right2[0].setPos(0.0F, 7.0F, 1.0F);
        ...
        body_lower[0].setPos(0.0F, 0.0F, 0.0F);
        ...
        teeth_upper1[0].setPos(0.0F, 1.0F, -3.0F);
        ...
        leg_front_right3[0].setPos(0.0F, 6.0F, 0.0F);
        ...
        tinyurn3[0].setPos(-4.0F, 4.0F, 3.0F);
        ...
        teethlower[0].setPos(0.0F, 0.0F, -3.0F);
        ...
        leg_front_left3[0].setPos(0.0F, 6.0F, 0.0F);
        ...
        leg_front_right2[0].setPos(0.0F, 5.0F, 2.0F);
        ...
        leg_front_left1[0].setPos(4.0F, 2.0F, -6.0F);
        ...
        leg_back_left2[0].setPos(0.0F, 7.0F, 1.0F);
        ...
        leg_back_left1[0].setPos(4.0F, 0.0F, 7.0F);
        ...
        cheeckybreeky_right[0].setPos(-2.0F, 0.0F, -3.0F);
        ...
        ear_left[0].setPos(3.0F, 0.0F, 0.0F);
        ...
        cheekybreeky_left[0].setPos(2.0F, 0.0F, -3.0F);
        ...
        teeth_upper2[0].setPos(0.0F, 1.0F, -3.0F);
     ...
     // Standing model
        ...
        leg_back_right1[1].setPos(-4.0F, 4.0F, 6.0F);
        ...
        tinyurn2[1].setPos(-1.0F, 6.0F, 3.0F);
        ...
        leg_front_right2[1].setPos(0.0F, 5.0F, 2.0F);
        ...
        body_main[1].setPos(0.0F, 8.0F, 4.0F);
        ...
        leg_front_right1[1].setPos(-4.0F, 2.0F, -6.0F);
        ...
        cheeckybreeky_right[1].setPos(-2.0F, 0.0F, -3.0F);
        ...
        body_lower[1].setPos(0.0F, 0.0F, 0.0F);
        ...
        leg_front_left2[1].setPos(0.0F, 5.0F, 2.0F);
        ...
        teeth_upper2[1].setPos(0.0F, 1.0F, -3.0F);
        ...
        leg_front_left1[1].setPos(4.0F, 2.0F, -6.0F);
        ...
        teeth_upper1[1].setPos(0.0F, 1.0F, -3.0F);
        ...
        tinyurn3[1].setPos(-4.0F, 4.0F, 3.0F);
        ...
        leg_back_left2[1].setPos(0.0F, 6.0F, 1.0F);
        ...
        lowerjaw[1].setPos(0.0F, 4.0F, -3.8F);
        ...
        leg_front_left3[1].setPos(0.0F, 6.0F, 0.0F);
        ...
        tinyurn1[1].setPos(2.0F, 6.0F, 3.0F);
        ...
        leg_back_right2[1].setPos(0.0F, 6.0F, 1.0F);
        ...
        ear_right[1].setPos(-3.0F, 0.0F, 0.0F);
        ...
        teethlower[1].setPos(0.0F, 0.0F, -3.0F);
        ...
        leg_back_left1[1].setPos(4.0F, 4.0F, 6.0F);
        ...
        leg_back_left3[1].setPos(0.0F, 6.0F, 0.0F);
        ...
        ear_left[1].setPos(3.0F, 0.0F, 0.0F);
        ...
        leg_back_right3[1].setPos(0.0F, 6.0F, 0.0F);
        ...
        cheekybreeky_left[1].setPos(2.0F, 0.0F, -3.0F);
        ...
        leg_front_right3[1].setPos(0.0F, 6.0F, 0.0F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAngle, float entityTickTime, float yRot, float xRot, float unitPixel, Entity entity) {
		...
		if(!crypt_crawler.isBiped()) {
			...
			neck[1].yRot = heady;
			neck[1].xRot = 0.36425021489121656F + headx;
		}
	}
	...
	public void setLivingAnimations(LivingEntity entity, float limbSwing, float limbSwingAngle, float partialRenderTicks) {
		...
		if(!crypt_crawler.isBiped()) {
			...
			float flap = MathHelper.sin((crypt_crawler.tickCount + partialRenderTicks) * 0.3F) * 0.8F;
			float standingAngle = crypt_crawler.smoothedStandingAngle(partialRenderTicks); 
			
			tail1[0].xRot = -0.40980330836826856F + (standingAngle * 0.75F)- animation * 1F;
			tail2[0].xRot = -0.22759093446006054F + (standingAngle * 0.75F)- animation * 3F;
			tail3[0].xRot = -0.22759093446006054F + (standingAngle * 0.75F)- animation * 4F;
			tail4[0].xRot = 0.22759093446006054F + (standingAngle * 0.75F)- animation * 5F;

		    tinyurn1[0].xRot = 0.136659280431156F + (standingAngle);
		    tinyurn2[0].xRot = 0.136659280431156F + (standingAngle);
		    tinyurn3[0].xRot = 0.136659280431156F + (standingAngle);
	
			if (crypt_crawler.standingAngle < 0.01f) {
				leg_front_right1[0].xRot = 0.27314402793711257F + (animation2 * 8F) + flap * 0.05F;
				leg_front_right2[0].xRot = -0.5918411493512771F + (animation2 * 6F) - flap * 0.025F;
				leg_front_right3[0].xRot = 0.5918411493512771F -(standingAngle*1.25F) -0.17453292519943295F - animation2 * 18F + flap * 0.05F;

				leg_front_left1[0].xRot = 0.27314402793711257F + (animation * 8F) + flap * 0.05F;
				leg_front_left2[0].xRot = -0.5918411493512771F + (animation * 6F) - flap * 0.025F;
				leg_front_left3[0].xRot = 0.5918411493512771F -(standingAngle * 1.25F) -0.17453292519943295F - (animation * 18F) + flap * 0.05F;

				leg_back_right1[0].xRot = 0.27314402793711257F -(standingAngle * 0.75F) -0.1F - (animation2 * 6F) - flap * 0.05F;
				leg_back_left1[0].xRot = 0.27314402793711257F -(standingAngle * 0.75F) -0.1F - (animation3 * 6F) - flap * 0.05F;
	
				leg_back_right1[0].yRot = 0.18203784098300857F - (standingAngle * 0.0625F);
				leg_back_left1[0].yRot = -0.18203784098300857F + (standingAngle * 0.0625F);

				leg_back_right2[0].xRot = standingAngle -0.7740535232594852F + (leg_back_right1[0].xRot + animation2) + flap * 0.1F;
				leg_back_left2[0].xRot = standingAngle -0.7740535232594852F + (leg_back_left1[0].xRot + animation3) + flap * 0.1F;

				leg_back_right3[0].xRot = 0.8651597102135892F -(standingAngle * 0.5F) - (leg_back_right1[0].xRot * 1.25F) - flap * 0.05F;
				leg_back_left3[0].xRot = 0.8651597102135892F -(standingAngle * 0.5F) - (leg_back_left1[0].xRot * 1.25F) - flap * 0.05F;

				body_main[0].xRot = 0.091106186954104F - standingAngle - (animation2 * 3F) - flap * 0.025F;
				body_main[0].zRot = 0F - animation2 * 1.5F;

				body_lower[0].xRot = -0.22759093446006054F + standingAngle + (animation2 * 2F) + flap * 0.05F;

				neck[0].xRot = 0.27314402793711257F -(standingAngle * 0.5F) -0.17453292519943295F + (animation2 * 2.9F) + flap * 0.025F;
				head1[0].xRot = -(standingAngle * 0.5F) + 0.17453292519943295F;
				head1[0].zRot = -(standingAngle * 0.1F * flap * 6F);
			
				body_main[0].rotationPointY = 12.0f;
			} else {
				leg_front_right1[0].xRot = 0.27314402793711257F + (standingAngle * 0.5F * flap) + animation2 * 6F;
				leg_front_left1[0].xRot = 0.27314402793711257F + (standingAngle * 0.5F * flap) + animation * 6F;

				leg_front_right2[0].xRot = -0.5918411493512771F + animation2 * 5F;
				leg_front_left2[0].xRot = -0.5918411493512771F + animation * 5F;

				leg_front_right3[0].xRot = 0.5918411493512771F + (standingAngle * 1.25F) -0.17453292519943295F - animation2 * 12F;
				leg_front_left3[0].xRot = 0.5918411493512771F + (standingAngle * 1.25F) -0.17453292519943295F - animation * 12F;

				leg_back_right1[0].xRot = 0.27314402793711257F + (standingAngle * 0.5F) - animation2 * 5F;
				leg_back_left1[0].xRot =  0.27314402793711257F + (standingAngle * 0.5F) - animation3 * 5F;

				leg_back_right1[0].yRot = 0.18203784098300857F - (standingAngle * 0.1625F);
				leg_back_left1[0].yRot = -0.18203784098300857F + (standingAngle * 0.1625F);

				leg_back_right2[0].xRot = -0.7740535232594852F + (standingAngle * 1.25F) + (leg_back_right1[0].xRot + animation2);
				leg_back_left2[0].xRot = -0.7740535232594852F + (standingAngle * 1.25F) + (leg_back_left1[0].xRot + animation3);

				leg_back_right3[0].xRot = 0.8651597102135892F +(standingAngle * 0.125F) - leg_back_right1[0].xRot * 1.25F;
				leg_back_left3[0].xRot = 0.8651597102135892F +(standingAngle * 0.125F) - leg_back_left1[0].xRot * 1.25F;

				body_main[0].xRot = 0.091106186954104F - (standingAngle) - animation2 * 2F;
				body_lower[0].xRot = -0.22759093446006054F - (standingAngle * 0.5F) + animation2 * 2F;

				neck[0].xRot = 0.27314402793711257F + (standingAngle * 0.25F) -0.17453292519943295F + animation2 * 2.9F;
				head1[0].xRot = 0.17453292519943295F + (standingAngle * 0.5F);
				
				body_main[0].zRot = 0F - animation2 * 1.5F * (1 - standingAngle);
				
				body_main[0].rotationPointY = 12.0f - standingAngle * 5.8f;
			}
			if (!crypt_crawler.onGround) {
				lowerjaw[0].xRot = -0.091106186954104F;
			} else {
				if (standingAngle > 0) {
					lowerjaw[0].xRot = 0.091106186954104F + flap * 0.5F;
				} else {
					lowerjaw[0].xRot = -0.091106186954104F + flap * 0.3F;
				}
			}
		} else {
			float animation = MathHelper.sin(limbSwing * 0.4F) * limbSwingAngle * 0.2F;
			float flap = MathHelper.sin((crypt_crawler.tickCount + partialRenderTicks) * 0.3F) * 0.8F;
			tail1[1].xRot = 0.36425021489121656F - animation * 0.25F;
			tail2[1].xRot = 0.22759093446006054F - animation * 0.5F;
			tail3[1].xRot = 0.22759093446006054F - animation * 0.75F;
			tail4[1].xRot = 0.22759093446006054F - animation * 1F;
			if (!crypt_crawler.isBlocking()) {
				leg_front_right1[1].xRot = 0.9105382707654417F - 1F + animation * 2F;
				leg_front_left1[1].xRot = 0.9105382707654417F - 1F - animation * 2F;

				leg_front_right1[1].zRot = -0.091106186954104F + 0.25F;
				leg_front_left1[1].zRot = 0.091106186954104F - 0.25F;

				leg_front_right1[1].yRot = -0.31869712141416456F;
				leg_front_left1[1].yRot = 0.31869712141416456F;

				leg_front_right2[1].xRot = -0.27314402793711257F;
				leg_front_left2[1].xRot = -0.27314402793711257F;

				leg_front_right3[1].xRot = 1.1838568316277536F;
				leg_front_left3[1].xRot = 1.1838568316277536F;
				leg_front_left3[1].zRot = 0.0F;
			} else {
				leg_front_right1[1].xRot = 0.9105382707654417F - 1F;
				leg_front_left1[1].xRot = 0.9105382707654417F - 1F - (animation - flap * 0.025F);

				leg_front_right1[1].zRot = -0.091106186954104F + 0.25F;
				leg_front_left1[1].zRot = 0.091106186954104F - 0.25F;

				leg_front_right1[1].yRot = -0.31869712141416456F;
				leg_front_left1[1].yRot = 0.6F;

				leg_front_right2[1].xRot = -0.27314402793711257F;
				leg_front_left2[1].xRot = -0.27314402793711257F;

				leg_front_right3[1].xRot = 1.1838568316277536F;
				leg_front_left3[1].xRot = 1.6F;
				leg_front_left3[1].zRot = 0.8F;
			}

			leg_back_right1[1].xRot = 1.6390387005478748F + animation * 5F - flap * 0.05F;
			leg_back_left1[1].xRot =  1.6390387005478748F  - animation * 5F - flap * 0.05F;

			leg_back_right1[1].yRot = -0.045553093477052F;
			leg_back_left1[1].yRot = -0.045553093477052F;

			leg_back_right2[1].xRot = -1.0927506446736497F - animation * 5F + flap * 0.05F;
			leg_back_left2[1].xRot = -1.0927506446736497F + animation * 5F + flap * 0.05F;

			leg_back_right3[1].xRot = 0.7740535232594852F + animation * 5F - flap * 0.05F;
			leg_back_left3[1].xRot = 0.7740535232594852F - animation * 5F - flap * 0.05F;
			

			body_main[1].xRot = -0.7740535232594852F - animation - flap * 0.025F;

			body_lower[1].xRot = -0.40980330836826856F + animation + flap * 0.05F;

			head1[1].xRot = 0.5462880558742251F;

			if (!crypt_crawler.onGround)
				lowerjaw[1].xRot = -0.091106186954104F;
			else
				lowerjaw[1].xRot = 0.091106186954104F + flap * 0.5F;
			...
			if (swingProgress > 0.0F) {
				...
				body_main[1].yRot = MathHelper.sin(MathHelper.sqrt(f1) * ((float) Math.PI * 2F)) * 0.5F;

				if (enumhandside == EnumHandSide.LEFT)
					body_main[1].yRot *= -1.0F;
				...
				float f3 = MathHelper.sin(swingProgress * (float) Math.PI) * -(head1[1].xRot + 0.7F) * 0.75F;
				modelrenderer.xRot = (float) ((double) modelrenderer.xRot - ((double) f2 * 0.8D + (double) f3));
				modelrenderer.yRot += body_main[1].yRot;
				modelrenderer.zRot += MathHelper.sin(swingProgress * (float) Math.PI) * -0.4F;
			}
		}
	}
