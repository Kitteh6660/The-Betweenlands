...
public class ModelFirefly extends Model {
	...
	public ModelFirefly() {
		...
		this.leg_left1b.setPos(0.0F, 1.0F, 0.0F);
		...
		this.thorax.setPos(0.0F, 0.0F, 0.0F);
		...
		this.leg_right1b.setPos(0.0F, 1.0F, 0.0F);
		...
		this.leg_right2.setPos(-1.0F, 0.8F, 0.0F);
		...
		this.thorax3.setPos(0.0F, 2.0F, 0.0F);
		...
		this.leg_left3.setPos(1.0F, 1.3F, 0.0F);
		...
		this.antenna_left.setPos(0.1F, 0.0F, -2.0F);
		...
		this.antenna_right.setPos(-0.1F, 0.0F, -2.0F);
		...
		this.leg_right1.setPos(-1.0F, 0.4F, 0.0F);
		...
		this.leg_right3.setPos(-1.0F, 1.3F, 0.0F);
		...
		this.thorax2.setPos(0.0F, 2.0F, 2.0F);
		...
		this.wing_left.setPos(0.0F, 0.0F, 0.0F);
		...
		this.dekschild.setPos(0.0F, -0.0F, 2.0F);
		...
		this.leg_left1.setPos(1.0F, 0.4F, 0.0F);
		...
		this.leg_left2.setPos(1.0F, 0.8F, 0.0F);
		...
		this.wing_right.setPos(0.0F, 0.0F, 0.0F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entity) {
		...
		this.wing_left.zRot = -0.5F - flap;
		this.wing_right.zRot = 0.5F + flap;
