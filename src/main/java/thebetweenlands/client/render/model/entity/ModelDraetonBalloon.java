 ...
 */
public class ModelDraetonBalloon extends Model {
    ...
    public ModelDraetonBalloon() {
        ...
        this.supportbeam_front2r.setPos(-12.0F, 0.0F, 0.0F);
        ...
        this.skin3r.setPos(-10.0F, 0.0F, 0.0F);
        ...
        this.rope_front_left1.setPos(3.0F, 0.0F, -4.0F);
        ...
        this.burner_vialconnection2.setPos(3.0F, 0.0F, -1.0F);
        ...
        this.balloon_main4.setPos(0.0F, 0.0F, -20.0F);
        ...
        this.supportbeam_back2r.setPos(-12.0F, 0.0F, 0.0F);
        ...
        this.skin1l.setPos(10.0F, 0.0F, 0.0F);
        ...
        this.rope_back_right1.setPos(-3.0F, 0.0F, 4.0F);
        ...
        this.skin2l.setPos(10.0F, 0.0F, 0.0F);
        ...
        this.supportbeam_back2l.setPos(12.0F, 0.0F, 0.0F);
        ...
        this.balloon_main1.setPos(0.0F, -16.0F, 0.0F);
        ...
        this.skin1r.setPos(-10.0F, 0.0F, 0.0F);
        ...
        this.balloon_back_r.setPos(-9.0F, 0.0F, 0.0F);
        ...
        this.balloon_front_l.setPos(9.0F, 0.0F, 0.0F);
        ...
        this.balloon_main3.setPos(0.0F, 0.0F, 20.0F);
        ...
        this.skin3l.setPos(10.0F, 0.0F, 0.0F);
        ...
        this.balloon_side4l.setPos(9.0F, 0.0F, 0.0F);
        ...
        this.balloon_back.setPos(0.0F, 0.0F, 12.0F);
        ...
        this.balloon_side1l.setPos(9.0F, 0.0F, 0.0F);
        ...
        this.heatvent2.setPos(0.0F, -2.0F, 7.0F);
        ...
        this.skin4l.setPos(10.0F, 0.0F, 0.0F);
        ...
        this.skin4r.setPos(-10.0F, 0.0F, 0.0F);
        ...
        this.balloon_back_l.setPos(9.0F, 0.0F, 0.0F);
        ...
        this.supportbeam_front1l.setPos(12.0F, 0.0F, 0.0F);
        ...
        this.balloon_side2r.setPos(-9.0F, 0.0F, 0.0F);
        ...
        this.bone2.setPos(0.0F, 0.0F, -14.0F);
        ...
        this.supportbeam_back1r.setPos(-12.0F, 0.0F, 0.0F);
        ...
        this.balloon_main2.setPos(0.0F, -16.0F, 0.0F);
        ...
        this.supportbeam_back1l.setPos(12.0F, 0.0F, 0.0F);
        ...
        this.balloon_side1r.setPos(-9.0F, 0.0F, 0.0F);
    ...
    public void renderToBuffer(MatrixStack matrix, IVertexBuilder vertex, int in1, int in2, float f, float f1, float f2, float f3) {  
    	this.render(matrix, vertex, in1, in2, f, f1, f2, f3);
    }
