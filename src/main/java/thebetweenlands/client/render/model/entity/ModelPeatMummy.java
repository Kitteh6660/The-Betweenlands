...
public class ModelPeatMummy extends MowzieModelBase {
	...
	public ModelPeatMummy() {
		...
		this.neck.setPos(0.0F, -1.5F, -5.02F);
		...
		this.legleft.setPos(0.0F, 0.0F, 0.0F);
		...
		this.jaw.setPos(0.0F, 1.1F, 0.0F);
		...
		this.shoulderJoint.setPos(0.0F, -9.026879981515934F, 0.2252155455684F);
		...
		this.shoulderright.setPos(0.0F, 2.5F, -1.5000000000000004F);
		...
		this.buttJoint.setPos(0.0F, 0.5420018484064801F, 1.5215545568400013F);
		...
		this.cheecktissueright.setPos(0.0F, 0.0F, 0.0F);
		...
		this.cheecktissue2.setPos(0.0F, 0.0F, 0.0F);
		...
		this.legright2.setPos(0.0F, 8.0F, 0.0F);
		...
		this.armright2.setPos(0.0F, 9.0F, 0.0F);
		...
		this.sexybutt.setPos(0.0F, 3.9F, -2.0F);
		...
		this.legleftJoint.setPos(4.0F, 3.5F, 1.5F);
		...
		this.legleft2.setPos(0.0F, 8.0F, 0.0F);
		...
		this.armrightJoint.setPos(-4.0F, -0.13F, -2.89F);
	...
	public void renderToBuffer(MatrixStack pMatrixStack, IVertexBuilder pBuffer, int pPackedLight, int pPackedOverlay, float pRed, float pGreen, float pBlue, float pAlpha) { 
		...
		this.modelBase.render(pMatrixStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
	}
	...
	public void setLivingAnimations(LivingEntity entity, float yaw, float pitch, float delta) {
		...
		body_base.xRot -= 1 - spawningProgress;
		armleftJoint.xRot -= 1.5 * (1 - spawningProgress);
		armrightJoint.xRot -= 1.5 * (1 - spawningProgress);
		...
		if (screamProgress != 0) {
			...
			body_base.xRot -= 1.6f * controller;
			body_base.rotationPointY -= 1.6f * controller;
			body_base.rotationPointZ -= 1.6f * controller;
			legleftJoint.xRot += 1.6f * controller;
			legrightJoint.xRot += 1.6f * controller;
			armleftJoint.xRot += 1.6f * controller;
			armrightJoint.xRot += 1.6f * controller;
			...
			armleftJoint.zRot += 0.5 * controller;
			armrightJoint.zRot -= 0.5 * controller;
			armleft2.xRot += 1 * controller;
			armright2.xRot += 1 * controller;
			jaw.xRot += 2.4 * controller + controller2 * 0.5 * Math.cos(4 * (mummy.tickCount + delta));
			cheecktissue2.xRot -= 2.4 * controller + controller2 * 0.5 * Math.cos(4 * (mummy.tickCount + delta));
			cheecktissue2.rotationPointY += 10 * controller;
			cheecktissueright.xRot -= 2.4 * controller + controller2 * 0.5 * Math.cos(4 * (mummy.tickCount + delta));
