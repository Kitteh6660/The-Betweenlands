...
@OnlyIn(Dist.CLIENT)
public class ModelShambler extends Model {
    ...
    public ModelShambler() {
        ...
        toe_left3.setPos(-0.5F, 0.0F, 2.0F);
        ...
        weird_butt.setPos(0.0F, 0.0F, 3.0F);
        ...
        mouth_arm2b.setPos(-0.5F, 0.5F, -4.0F);
        ...
        mouth_arm4b.setPos(-0.5F, -0.5F, -4.0F);
        ...
        toe_right2.setPos(0.0F, -0.2F, 0.0F);
        ...
        mouth_arm2a.setPos(3.9F, -3.3F, -5.0F);
        ...
        cranialthing1.setPos(0.0F, -1.5F, 1.0F);
        ...
        toe_right1.setPos(-0.5F, 0.0F, 2.0F);
        ...
        hindleg_left3.setPos(3.0F, 6.0F, 4.0F);
        ...
        toe_left1.setPos(0.5F, 0.0F, 2.0F);
        ...
        hindleg_right3.setPos(0.0F, 6.0F, 4.0F);
        ...
        hindleg_right1.setPos(-4.0F, 5.0F, 3.0F);
        ...
        mouth_arm2c.setPos(0.0F, 0.01F, -3.0F);
        ...
        hindleg_left1.setPos(4.0F, 5.0F, 3.0F);
        ...
        hindleg_left2.setPos(-1.02F, 3.0F, -5.0F);
        ...
        surprise_tail.setPos(0.0F, 6.0F, 4.0F);
        ...
        mouth_arm3c.setPos(0.0F, -0.01F, -3.0F);
        ...
        toe_left2.setPos(0.0F, -0.2F, 0.0F);
        ...
        mouth_arm4c.setPos(0.0F, -0.01F, -3.0F);
        ...
        toe_right3.setPos(0.5F, 0.0F, 2.0F);
        ...
        mouth_arm1b.setPos(0.5F, 0.5F, -4.0F);
        ...
        cranialthing2.setPos(0.0F, 0.0F, 3.0F);
        ...
        mouth_arm1a.setPos(-3.9F, -3.3F, -5.0F);
        ...
        mouth_arm1c.setPos(0.0F, 0.01F, -3.0F);
        ...
        foot_left1.setPos(-1.5F, 4.0F, -4.0F);
        ...
        hindleg_right2.setPos(-1.99F, 3.0F, -5.0F);
        ...
        mouth_arm4a.setPos(3.9F, 4.3F, -5.0F);
	...
	@Override
	public void render(Entity entity, float limbSwing, float limbSwingAmount, float tickCount, float yRot, float xRot, float scale) {
		float flap = MathHelper.sin(tickCount * 0.3F) * 0.8F;
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		head1.yRot = (float)MathHelper.clamp(Math.toRadians(netHeadYaw), -60, 60);
	}
	...
	public void setLivingAnimations(LivingEntity entity, float limbSwing, float limbSwingAmount, float partialTickTime ) {
		...
		float flap = MathHelper.sin((shambler.tickCount + partialTickTime) * 0.3F) * 0.8F;
		float smoothedAngle = shambler.smoothedAngle(partialTickTime);
		float headX = 0F + shambler.xRot / (180F / (float) Math.PI);
	    ...
	    mouth_arm1a.yRot = 0F + smoothedAngle / (180F / (float) Math.PI) * 4F - (!shambler.jawsAreOpen() ? 0F : flap * 0.3F);
	    mouth_arm1a.xRot = 0.08726646259971647F - smoothedAngle / (180F / (float) Math.PI) * 3F - (!shambler.jawsAreOpen() ? 0F : flap * 0.1F);

	    mouth_arm2a.yRot = 0F - smoothedAngle / (180F / (float) Math.PI) * 4F + (!shambler.jawsAreOpen() ? 0F : flap * 0.3F);
	    mouth_arm2a.xRot = 0.08726646259971647F - smoothedAngle / (180F / (float) Math.PI) * 3F - (!shambler.jawsAreOpen() ? 0F : flap * 0.1F);

	    mouth_arm3a.yRot = 0F + smoothedAngle / (180F / (float) Math.PI) * 4F - (!shambler.jawsAreOpen() ? 0F : flap * 0.3F);
	    mouth_arm3a.xRot = -0.08726646259971647F + smoothedAngle / (180F / (float) Math.PI) * 3F - (!shambler.jawsAreOpen() ? 0F : flap * 0.1F);

	    mouth_arm4a.yRot = 0F - smoothedAngle / (180F / (float) Math.PI) * 4F + (!shambler.jawsAreOpen() ? 0F : flap * 0.3F);
	    mouth_arm4a.xRot = -0.08726646259971647F + smoothedAngle / (180F / (float) Math.PI) * 3F - (!shambler.jawsAreOpen() ? 0F : flap * 0.1F);

	    mouth_arm1c.yRot = - 0.5462880558742251F + smoothedAngle / (180F / (float) Math.PI) * 3F - (!shambler.jawsAreOpen() ? 0F : flap * 0.5F);
	    mouth_arm2c.yRot = 0.5462880558742251F - smoothedAngle / (180F / (float) Math.PI) * 3F + (!shambler.jawsAreOpen() ? 0F : flap * 0.5F);
	    mouth_arm3c.yRot = -0.5462880558742251F + smoothedAngle / (180F / (float) Math.PI) * 3F - (!shambler.jawsAreOpen() ? 0F : flap * 0.5F);
	    mouth_arm4c.yRot = 0.5462880558742251F - smoothedAngle / (180F / (float) Math.PI) * 3F + (!shambler.jawsAreOpen() ? 0F : flap * 0.5F);

		tail2.xRot = 0.5009094953223726F - MathHelper.sin((animation) * 0.5009094953223726F) * 1F - 1F / 9 * shambler.getTongueLength() * 0.5F;
		tail3.xRot = 0.7740535232594852F - MathHelper.sin((animation) * 0.7740535232594852F) * 1F - 1F / 9 * shambler.getTongueLength()* 0.5F;
		tail4.xRot = 0.8651597102135892F - MathHelper.sin((animation) * 0.8651597102135892F) * 1F - 1F / 9 * shambler.getTongueLength();
		tail5.xRot = 0.8651597102135892F - MathHelper.sin((animation) * 0.8651597102135892F) * 1F - 1F / 9 * shambler.getTongueLength();
		tail6.xRot = 0.8196066167365371F - MathHelper.sin((animation) *  0.8196066167365371F) * 1F - 1F / 9 * shambler.getTongueLength() * 0.75F;
	}
