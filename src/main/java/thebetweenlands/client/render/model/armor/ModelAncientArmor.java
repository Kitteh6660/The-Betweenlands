...
public class ModelAncientArmor extends ModelBodyAttachment {
	...
	public ModelAncientArmor(float expand) {
		...
		lowerplate_left.setPos(1.5F, 1.0F, 0.0F);
		...
		chestpiece_left1.setPos(0.0F, 1.0F, -3.5F);
		...
		antlers_left1f.setPos(0.0F, 0.0F, 1.0F);
		...
		antlers_right1h.setPos(0.0F, 0.0F, 2.0F);
		...
		shoulderpad_right.setPos(0.0F, 0.0F, 0.0F);
		...
		belt_add2.setPos(0.0F, 1.0F, 0.0F);
		...
		topplate2.setPos(0.0F, -1.0F, 0.0F);
		...
		chestplate_armrotation_right.setPos(-5.0F, 2.0F, 0.0F);
		...
		antler_right1a.setPos(-2.5F, -1.5F, -0.5F);
		...
		boots_right_toes.setPos(0.0F, 9.5F, -2.0F);
		...
		antler_left1a.setPos(2.5F, -1.5F, -0.5F);
		...
		antler_left1c.setPos(0.0F, -1.0F, 2.0F);
		...
		foreheadpiece.setPos(0.0F, 2.0F, -3.0F);
		...
		antlers_left1g.setPos(0.0F, 0.0F, 2.0F);
		...
		antlers_left1j.setPos(2.0F, -1.0F, 1.0F);
		...
		sideplate2.setPos(0.0F, 2.0F, 5.0F);
		...
		antlers_left1i.setPos(0.0F, 0.0F, 2.0F);
		...
		chestpiece_right1.setPos(0.0F, 1.0F, -3.5F);
		...
		antler_left1d.setPos(2.0F, 0.0F, 1.0F);
		...
		helmet_mainrotation.setPos(0.0F, 0.0F, 0.0F);
		...
		antler_right1e.setPos(0.0F, 2.0F, 2.0F);
		...
		antlers_left1h.setPos(0.0F, 0.0F, 2.0F);
		...
		antler_right1b.setPos(0.0F, -1.0F, -1.0F);
		...
		shoulderpad_left.setPos(0.0F, 0.0F, 0.0F);
		...
		antler_right1c.setPos(0.0F, -1.0F, 2.0F);
		...
		antler_left1e.setPos(0.0F, 2.0F, 2.0F);
		...
		chestplate_armrotation_left.setPos(5.0F, 2.0F, 0.0F);
		...
		antler_right1d.setPos(-2.0F, 0.0F, 1.0F);
		...
		antlers_right1f.setPos(0.0F, 0.0F, 1.0F);
		...
		antlers_right1i.setPos(0.0F, 0.0F, 2.0F);
		...
		head.addChild(helmet_mainrotation);
		body.addChild(chestplate_mainrotation);
		body.addChild(leggings_mainrotation);
		rightArm.addChild(chestplate_armrotation_right);
		leftArm.addChild(chestplate_armrotation_left);
		rightLeg.addChild(boots_right_main);
		leftLeg.addChild(boots_left_main);
		rightLeg.addChild(chainmail_leg_right);
		leftLeg.addChild(chainmail_leg_left);
		...
		helmet_mainrotation.setPos(0F, -1.0F, 0F);
		chestplate_mainrotation.setPos(0F, 0F, 0F);
		boots_left_toes.setPos(0.0F, 10F, -2.0F);
		boots_right_toes.setPos(0.0F, 10F, -2.0F);
		boots_right_main.setPos(0F, 0F, 0F);
		boots_left_main.setPos(0F, 0F, 0F);
		chainmail_leg_right.setPos(0F, 0F, 0F);
		chainmail_leg_left.setPos(0F, 0F, 0F);
		chestplate_armrotation_right.setPos(0F, 0F, 0F);
		chestplate_armrotation_left.setPos(0F, 0F, 0F);
		leggings_mainrotation.setPos(0F, 10F, 0F);
	}

	public void setBootsVisible() {
		boots_right_main.visible = true;
		boots_left_main.visible = true;
	}

	public void setLegsVisible() {
		chainmail_leg_right.visible = true;
		chainmail_leg_left.visible = true;
		leggings_mainrotation.visible = true;
	}

	public void setChestVisible() {
		chestplate_mainrotation.visible = true;
		chestplate_armrotation_right.visible = true;
		chestplate_armrotation_left.visible = true;
	}

	public void setHelmVisible() {
		helmet_mainrotation.visible = true;
	}
	...
	public void resetVisibilities() {
		helmet_mainrotation.visible = false;
		chestplate_mainrotation.visible = false;
		chestplate_armrotation_right.visible = false;
		chestplate_armrotation_left.visible = false;
		boots_right_main.visible = false;
		boots_left_main.visible = false;
		leggings_mainrotation.visible = false;
		chainmail_leg_right.visible = false;
		chainmail_leg_left.visible = false;
	}

	public void setVisibilities(EquipmentSlotType slot) {
