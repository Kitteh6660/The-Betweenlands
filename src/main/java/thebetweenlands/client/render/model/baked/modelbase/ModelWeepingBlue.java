 ...
 */
public class ModelWeepingBlue extends Model {
	...
	public ModelWeepingBlue() {
		...
		this.leaf3.setPos(-0.5F, -6.0F, 0.5F);
		...
		this.flower4.setPos(-0.3F, -5.5F, 0.8F);
		...
		this.flower2c.setPos(0.0F, -0.1F, 0.0F);
		...
		this.leaf7b.setPos(0.0F, 0.0F, -5.0F);
		...
		this.leaf7.setPos(0.5F, 0.0F, 0.0F);
		...
		this.stalk4.setPos(0.0F, -5.9F, 0.0F);
		...
		this.flower5.setPos(-0.4F, -5.5F, -0.5F);
		...
		this.flower1a.setPos(0.5F, -6.0F, -0.3F);
		...
		this.leaf4b.setPos(0.0F, 0.0F, -6.0F);
		...
		this.flower3.setPos(0.8F, -5.5F, -0.3F);
		...
		this.leaf5.setPos(0.5F, -6.0F, 0.0F);
		...
		this.stalk2.setPos(0.0F, -7.9F, 0.0F);
		...
		this.leaf4.setPos(0.0F, -6.0F, 0.5F);
		...
		this.leaf6.setPos(-0.5F, 0.0F, -0.5F);
		...
		this.leaf1.setPos(0.0F, -6.0F, -0.5F);
		...
		this.flower2a.setPos(-1.0F, -6.0F, 0.0F);
