...
public class ModelWhitePearCrop4 extends Model {
    ...
    public ModelWhitePearCrop4() {
        ...
        this.stem5.addChild(this.blossom1);
        this.blossom2.addChild(this.thing2);
        ...
        this.blossom1.addChild(this.thing1);
        ...
        this.blossom3.addChild(this.thing3);
