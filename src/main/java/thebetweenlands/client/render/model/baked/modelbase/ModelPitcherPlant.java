 ...
 */
public class ModelPitcherPlant extends Model {
	...
	public ModelPitcherPlant() {
		...
		this.top2.setPos(0.0F, -16.9F, 0.0F);
		...
		this.tube3.setPos(0.0F, -4.0F, 0.0F);
		...
		this.trapleaf3.setPos(0.0F, -4.0F, 1.5F);
		...
		this.leaf5b.setPos(0.0F, 0.0F, -4.0F);
		...
		this.plantbase1.setPos(-3.0F, 24.0F, -3.0F);
		...
		this.tube2.setPos(0.0F, -5.0F, 0.0F);
		...
		this.lure1.setPos(0.0F, 0.0F, 0.0F);
		...
		this.leaf4.setPos(-1.5F, 24.0F, 2.0F);
		...
		this.lure2.setPos(0.0F, 0.0F, 0.0F);
		...
		this.leaf4b.setPos(0.0F, 0.0F, -5.0F);
		...
		this.top3.setPos(0.0F, -10.8F, 0.0F);
		...
		this.leaf5.setPos(-1.5F, 23.0F, 2.0F);
		...
		this.leaf1.setPos(-3.0F, 24.0F, -3.0F);
		...
		this.plantbase3.setPos(3.0F, 24.0F, -1.0F);
		...
		this.sprout1.setPos(2.0F, 24.0F, 3.0F);
		...
		this.top1.setPos(0.0F, -14.8F, 0.0F);
		...
		this.lure3.setPos(0.0F, 0.0F, 0.0F);
		...
		this.leaf2b.setPos(0.0F, 0.0F, -4.0F);
		...
		this.plantbase2.setPos(-1.5F, 24.0F, 2.0F);
		...
		this.sprout2.setPos(1.0F, 24.0F, -4.0F);
		...
		this.leaf2.setPos(-3.0F, 22.5F, -3.0F);
		...
		this.leaf3.setPos(3.0F, 23.0F, -1.0F);
		...
		this.sproutleaf2.setPos(0.0F, -2.0F, 1.0F);
		...
		this.trapleaf2.setPos(0.0F, -4.0F, -1.5F);
		...
		this.sproutleaf1.setPos(0.0F, -3.0F, -1.0F);
		...
		this.trapleaf1.setPos(0.0F, -4.0F, 1.5F);
		...
		this.leaf3b.setPos(0.0F, 0.0F, -5.0F);
		...
		this.tube1.setPos(0.0F, -4.0F, 0.0F);
