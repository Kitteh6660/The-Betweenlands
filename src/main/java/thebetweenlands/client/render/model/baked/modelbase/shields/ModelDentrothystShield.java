 ...
 */
public class ModelDentrothystShield extends Model {
	...
	public ModelDentrothystShield() {
		...
		this.beam3.setPos(0.0F, -6.0F, 0.0F);
		...
		this.leaf1.setPos(3.0F, 0.0F, 0.0F);
		...
		this.beam1.setPos(3.5F, 0.0F, -1.0F);
		...
		this.shield_main.setPos(0.0F, 1.0F, -1.0F);
		...
		this.plate2.setPos(0.0F, -6.0F, -2.0F);
		...
		this.leaf3.setPos(0.0F, -2.0F, 0.0F);
		...
		this.beam6.setPos(0.0F, 3.0F, 0.0F);
		...
		this.beam2.setPos(3.0F, -5.0F, 0.0F);
		...
		this.beam4.setPos(-3.0F, -7.0F, 0.0F);
		...
		this.beam5.setPos(0.0F, 6.0F, 0.0F);
		...
		this.leaf4.setPos(0.0F, -2.0F, 0.0F);
		...
		this.plate1.setPos(0.0F, 6.0F, -2.0F);
