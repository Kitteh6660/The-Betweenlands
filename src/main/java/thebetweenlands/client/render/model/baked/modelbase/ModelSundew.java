 ...
 */
public class ModelSundew extends Model {
	...
	public ModelSundew() {
		...
		this.stalk4.setPos(0.0F, -6.0F, 2.0F);
		...
		this.flowerthing4.setPos(0.01F, -3.0F, 0.0F);
		...
		this.stalk3.setPos(0.0F, -6.0F, 0.0F);
		...
		this.flowerthing1.setPos(0.0F, -5.7F, -1.0F);
		...
		this.flowerthing2.setPos(0.0F, -3.0F, 1.5F);
		...
		this.stalk2.setPos(0.0F, -6.0F, -1.0F);
