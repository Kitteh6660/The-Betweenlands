...
public class ModelVolarpad extends Model {
	...
	public ModelVolarpad() {
		...
		this.moss2.setPos(6.0F, 0.0F, 0.0F);
		...
		this.stalk5.setPos(0.0F, -9.8F, 0.0F);
		...
		this.pad1dl2.setPos(-13.9F, 0.0F, 0.0F);
		...
		this.stalk3.setPos(0.0F, -9.8F, 0.0F);
		...
		this.pad1ar.setPos(14.9F, 0.0F, 0.0F);
		...
		this.pad1b.setPos(0.0F, 0.0F, -0.1F);
		...
		this.stalk2.setPos(0.0F, -9.8F, 0.0F);
		...
		this.pad1br.setPos(14.9F, 0.0F, 0.0F);
		...
		this.pad1dr2.setPos(13.9F, 0.0F, 0.0F);
		...
		this.pad1a.setPos(0.0F, 0.0F, -14.9F);
		...
		this.pad1bl.setPos(-14.9F, 0.0F, 0.0F);
		...
		this.moss1.setPos(-0.1F, 0.0F, -0.1F);
		...
		this.pad1hl.setPos(0.0F, 0.0F, 1.9F);
		...
		this.roots.setPos(0.0F, 12.5F, 0.0F);
		...
		this.pad1fr.setPos(0.0F, 0.0F, 3.9F);
		...
		this.pad1fl.setPos(0.0F, 0.0F, 3.9F);
		...
		this.pad1al.setPos(-14.9F, 0.0F, 0.0F);
		...
		this.pad1dr.setPos(1.0F, 0.0F, 8.9F);
