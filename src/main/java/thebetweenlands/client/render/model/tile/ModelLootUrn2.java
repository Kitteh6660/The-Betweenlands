...
@OnlyIn(Dist.CLIENT)
public class ModelLootUrn2 extends Model {
    ...
    public ModelLootUrn2() {
        ...
        this.leg2.setPos(-2.0F, 0.0F, -2.0F);
        ...
        this.leg3.setPos(-2.0F, 0.0F, 2.0F);
        ...
        this.base.setPos(0.0F, 21.5F, 0.0F);
        ...
        this.leg1.setPos(2.0F, 0.0F, -2.0F);
        ...
        this.leg4.setPos(2.0F, 0.0F, 2.0F);
