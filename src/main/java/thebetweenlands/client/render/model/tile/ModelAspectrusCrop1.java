 ...
 */
public class ModelAspectrusCrop1 extends Model {
	...
	public ModelAspectrusCrop1() {
		...
		this.leaf3.setPos(-2.0F, -3.0F, 2.5F);
		...
		this.leaf2.setPos(2.5F, -4.0F, 1.5F);
		...
		this.leaf5.setPos(-2.5F, -5.0F, 1.0F);
		...
		this.leaf4.setPos(1.0F, -6.0F, -2.5F);
		...
		this.leafb.setPos(0.0F, 0.0F, -3.5F);
		...
		this.leaf1.setPos(-1.5F, -2.0F, -2.5F);
