 ...
 */
public class ModelRuneWeavingTable extends Model {
	...
	public ModelRuneWeavingTable() {
		...
		this.leg_front_left1b.setPos(0.0F, 6.0F, 0.0F);
		...
		this.scroll1b.setPos(0.0F, -1.0F, 0.0F);
		...
		this.bobbin_rope.setPos(0.0F, -1.0F, 0.0F);
		...
		this.scroll1a.setPos(-5.5F, 0.0F, 0.0F);
		...
		this.leg_front_right1a.setPos(-7.0F, 0.0F, -3.0F);
		...
		this.leg_front_left1a.setPos(7.0F, 0.0F, -3.0F);
		...
		this.scroll2a.setPos(-3.0F, 0.0F, -1.0F);
		...
		this.leg_back_right1a.setPos(-7.0F, 0.0F, 3.0F);
		...
		this.scroll2b.setPos(0.0F, -1.0F, 0.0F);
		...
		this.bobbin_top.setPos(0.0F, -2.0F, 0.0F);
		...
		this.scroll3b.setPos(0.0F, -1.0F, 0.0F);
		...
		this.bobbin_string.setPos(1.0F, 0.0F, -1.0F);
		...
		this.stoneslate2.setPos(0.0F, -1.0F, 0.8F);
		...
		this.rope_front.setPos(0.0F, 0.5F, -6.0F);
		...
		this.stoneslate1.setPos(16.0F, 12.0F, 1.0F);
		...
		this.leg_back_right1b.setPos(0.0F, 6.0F, 0.0F);
		...
		this.leg_back_left1a.setPos(7.0F, 0.0F, 3.0F);
		...
		this.scroll3a.setPos(2.0F, 0.0F, 0.0F);
		...
		this.leg_back_left1b.setPos(0.0F, 6.0F, 0.0F);
		...
		this.bobbin_base.setPos(2.0F, -1.0F, 2.0F);
	...
	public void renderToBuffer(MatrixStack matrix, IVertexBuilder vertex, int in1, int in2, float f, float f1, float f2, float f3) {  
		this.table_woodbase.render(matrix, vertex, in1, in2, f, f1, f2, f3);
	}
