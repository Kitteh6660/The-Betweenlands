...
public class ModelInfuser extends Model {
	...
	public ModelInfuser() {
		...
		spoon_bottom.setPos(-0.6F, 13.9F, 2.5F);
		...
		cauldroncorner3.setPos(0.0F, 20.0F, 0.0F);
