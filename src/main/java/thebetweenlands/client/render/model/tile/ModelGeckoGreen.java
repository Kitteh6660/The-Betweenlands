...
public class ModelGeckoGreen extends MowzieModelBase {
	...
	public ModelGeckoGreen() {
		...
		this.head.setPos(0.0F, 21.5F, -4.5F);
		...
		this.connectionpiece.setPos(0.0F, 0.0F, 0.0F);
		...
		this.legright_b1.setPos(-2.0F, 22.0F, 0.5F);
		...
		this.jaw.setPos(0.0F, 0.0F, -1.0F);
		...
		this.legright_f1.setPos(-2.0F, 21.5F, -3.0F);
		...
		this.legleft_f1.setPos(2.0F, 21.5F, -3.0F);
		...
		this.crane.setPos(0.0F, -2.0F, -1.6F);
