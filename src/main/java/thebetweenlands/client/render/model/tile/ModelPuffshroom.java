...
public class ModelPuffshroom extends Model {
	...
	public ModelPuffshroom() {
		...
		back_c_tent_3.setPos(0.0F, -1.0F, 0.0F);
		...
		front_l_tent_3.setPos(0.0F, -3.0F, 0.0F);
		...
		back_r_tent_origin.setPos(2.0F, -1.5F, 2.0F);
		...
		front_r_tent_2.setPos(0.0F, -2.0F, 0.0F);
		...
		back_l_tent_origin.setPos(-2.0F, -1.5F, 2.0F);
		...
		funnel_front.setPos(0.0F, -8.5F, 0.0F);
		...
		right_c_tent_origin.setPos(2.2F, -1.5F, 0.0F);
		...
		front_r_tent_origin.setPos(2.0F, -1.5F, -2.0F);
		...
		front_r_tent_3.setPos(0.0F, -3.0F, 0.0F);
		...
		funnel_left.setPos(0.0F, -8.5F, 0.0F);
		...
		left_c_tent_origin.setPos(-2.2F, -1.5F, 0.0F);
		...
		back_r_tent_2.setPos(0.0F, -2.0F, 0.0F);
		...
		front_l_tent_2.setPos(0.0F, -2.0F, 0.0F);
		...
		right_c_tent_2.setPos(0.0F, -2.0F, 0.0F);
		...
		back_r_tent_3.setPos(0.0F, -3.0F, 0.0F);
		...
		front_c_tent_2.setPos(0.0F, -2.0F, 0.0F);
		...
		back_l_tent_3.setPos(0.0F, -3.0F, 0.0F);
		...
		front_l_tent_origin.setPos(-2.0F, -1.5F, -2.0F);
	...
	public void render(TileEntityPuffshroom tile, float partialTickTime) {
		...
		float interAnimationTicks_1 = tile.prev_animation_1 + (tile.animation_1 - tile.prev_animation_1) * partialTickTime;
		float interAnimationTicks_2 = tile.prev_animation_2 + (tile.animation_2 - tile.prev_animation_2) * partialTickTime;
		float interAnimationTicks_3 = tile.prev_animation_3 + (tile.animation_3 - tile.prev_animation_3) * partialTickTime;
		float interAnimationTicks_4 = tile.prev_animation_4 + (tile.animation_4 - tile.prev_animation_4) * partialTickTime;
		float smoothedTicks = tile.prev_renderTicks + (tile.renderTicks - tile.prev_renderTicks)* partialTickTime;
		...
		if (tile.active_1) {
			...
			back_c_tent_1.xRot = -0.7853981633974483F + interAnimationTicks_2 / (180F / (float) Math.PI) * 11.25F;
			front_c_tent_1.xRot = -0.7853981633974483F + interAnimationTicks_2 / (180F / (float) Math.PI) * 11.25F;
			left_c_tent_1.xRot = -0.7853981633974483F + interAnimationTicks_2 / (180F / (float) Math.PI) * 11.25F;
			right_c_tent_1.xRot = -0.7853981633974483F + interAnimationTicks_2 / (180F / (float) Math.PI) * 11.25F;
			
			back_c_tent_2.xRot = 0F + interAnimationTicks_2 / (180F / (float) Math.PI);
			front_c_tent_2.xRot = 0F + interAnimationTicks_2 / (180F / (float) Math.PI);
			left_c_tent_2.xRot = 0F + interAnimationTicks_2 / (180F / (float) Math.PI);
			right_c_tent_2.xRot = 0F + interAnimationTicks_2 / (180F / (float) Math.PI);

			back_c_tent_3.xRot = 0F + interAnimationTicks_2 / (180F / (float) Math.PI);
			front_c_tent_3.xRot = 0F + interAnimationTicks_2 / (180F / (float) Math.PI);
			left_c_tent_3.xRot = 0F + interAnimationTicks_2 / (180F / (float) Math.PI);
			right_c_tent_3.xRot = 0F + interAnimationTicks_2 / (180F / (float) Math.PI);
		

			back_r_tent_1.xRot = -0.7853981633974483F + interAnimationTicks_3 / (180F / (float) Math.PI) * 11.25F + flap;
			front_r_tent_1.xRot = -0.7853981633974483F + interAnimationTicks_3 / (180F / (float) Math.PI) * 11.25F - flap2;
			back_l_tent_1.xRot = -0.7853981633974483F + interAnimationTicks_3 / (180F / (float) Math.PI) * 11.25F - flap2;
			front_l_tent_1.xRot = -0.7853981633974483F + interAnimationTicks_3 / (180F / (float) Math.PI) * 11.25F + flap;
			
			back_r_tent_2.xRot = 0F - interAnimationTicks_3 / (180F / (float) Math.PI) * 1.40625F - flap * 2F;
			front_r_tent_2.xRot = 0F - interAnimationTicks_3 / (180F / (float) Math.PI) * 1.40625F + flap2 * 2F;
			back_l_tent_2.xRot = 0F - interAnimationTicks_3 / (180F / (float) Math.PI) * 1.40625F + flap2 * 2F;
			front_l_tent_2.xRot = 0F - interAnimationTicks_3 / (180F / (float) Math.PI) * 1.40625F - flap * 2F;
			
			back_r_tent_3.xRot = -0.7853981633974483F + (interAnimationTicks_3 - interAnimationTicks_4 * 0.5F) / (180F / (float) Math.PI) * 11.25F + flap * 4F;
			front_r_tent_3.xRot = -0.7853981633974483F + (interAnimationTicks_3 - interAnimationTicks_4 * 0.5F) / (180F / (float) Math.PI) * 11.25F - flap2 * 4F;
			back_l_tent_3.xRot = -0.7853981633974483F + (interAnimationTicks_3 - interAnimationTicks_4 * 0.5F) / (180F / (float) Math.PI) * 11.25F - flap2 * 4F;
			front_l_tent_3.xRot = -0.7853981633974483F + (interAnimationTicks_3 - interAnimationTicks_4 * 0.5F) / (180F / (float) Math.PI) * 11.25F + flap * 4F;

		
		if (tile.animation_1 < 8) {
