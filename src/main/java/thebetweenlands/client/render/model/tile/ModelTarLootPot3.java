...
@OnlyIn(Dist.CLIENT)
public class ModelTarLootPot3 extends Model {
	ModelRenderer foot;
	...
	public ModelTarLootPot3() {
		textureWidth = 128;
		textureHeight = 64;
		foot = new ModelRenderer(this, 0, 0);
		foot.setPos(-0.6F, 21.2F, 0.6F);
