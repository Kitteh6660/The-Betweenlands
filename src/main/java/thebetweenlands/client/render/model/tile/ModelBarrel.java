...
public class ModelBarrel extends Model {
    ...
    public ModelBarrel() {
        ...
        this.top_left.setPos(-2.0F, -6.0F, 0.0F);
        ...
        this.top_front.setPos(0.0F, -6.0F, 2.0F);
        ...
        this.side_back_2.setPos(0.0F, -6.0F, 3.0F);
    ...
    public void renderToBuffer(MatrixStack pMatrixStack, IVertexBuilder pBuffer, int pPackedLight, int pPackedOverlay, float pRed, float pGreen, float pBlue, float pAlpha) {  
        this.bottom_base_main.render(pMatrixStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
    }
