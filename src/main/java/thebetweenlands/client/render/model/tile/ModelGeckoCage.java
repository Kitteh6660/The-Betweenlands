 ...
 */
public class ModelGeckoCage extends Model {
	...
	public ModelGeckoCage() {
		...
		this.raster4b.setPos(0.0F, -5.0F, 0.0F);
		...
		this.raster1b.setPos(0.0F, -5.0F, 0.0F);
		...
		this.raster2.setPos(-1.0F, 0.0F, 0.0F);
		...
		this.edge3b.setPos(0.0F, 0.0F, 6.0F);
		...
		this.raster2b.setPos(0.0F, -5.0F, 0.0F);
		...
		this.raster3.setPos(0.0F, 0.0F, 1.0F);
		...
		this.edge1.setPos(0.0F, -2.0F, -6.0F);
		...
		this.raster4.setPos(1.0F, 0.0F, 0.0F);
		...
		this.raster3b.setPos(0.0F, -5.0F, 0.0F);
		...
		this.edge1b.setPos(0.0F, 0.0F, -6.0F);
		...
		this.edge2.setPos(-6.0F, -2.0F, 0.0F);
		...
		this.edge3.setPos(0.0F, -2.0F, 6.0F);
		...
		this.topbase.setPos(0.0F, -11.35F, 0.0F);
