...
public class ModelGeckoCorrupted extends MowzieModelBase {
	...
	public ModelGeckoCorrupted() {
		...
		this.legright_f1.setPos(-2.0F, 21.5F, -3.5F);
		...
		this.tail1.setPos(0.0F, 0.0F, 4.2F);
		...
		this.legleft_f1.setPos(2.0F, 21.5F, -2.2F);
		...
		this.crane.setPos(0.0F, -2.0F, 0.0F);
		...
		this.tongue.setPos(0.0F, -1.0F, -4.0F);
		...
		this.legleft_f2.setPos(0.0F, 1.5F, -0.5F);
		...
		this.legleft_b1.setPos(2.0F, 22.0F, 0.5F);
		...
		this.legright_b2.setPos(0.0F, 1.5F, 0.0F);
		...
		this.head.setPos(0.0F, 21.2F, -3.0F);
		...
		this.tail3.setPos(0.4F, 0.0F, 2.8F);
		...
		this.legright_b1.setPos(-2.0F, 22.0F, 1.3F);
		...
		this.legleft_b2.setPos(0.0F, 1.5F, 0.0F);
		...
		this.tail2.setPos(0.0F, 0.0F, 2.3F);
		...
		this.body_base.setPos(0.0F, 22.0F, -4.0F);
		...
		this.legright_f2.setPos(0.0F, 1.5F, -0.5F);
