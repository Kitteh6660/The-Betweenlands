...
public class ModelWaystone extends Model {
	...
	public ModelWaystone() {
		...
		this.objects1.setPos(0.0F, 0.0F, -4.4F);
		...
		this.rope3.setPos(0.0F, 6.0F, 0.0F);
		...
		this.rope4.setPos(0.0F, 6.0F, 0.0F);
		...
		this.object6b_1.setPos(0.0F, 2.0F, 0.0F);
		...
		this.rope1.setPos(-7.0F, 7.0F, 0.0F);
		...
		this.rope5.setPos(-7.0F, 0.9F, 0.0F);
	...
	public void renderToBuffer(MatrixStack pMatrixStack, IVertexBuilder pBuffer, int pPackedLight, int pPackedOverlay, float pRed, float pGreen, float pBlue, float pAlpha) {  
		this.slate1.render(pMatrixStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
		this.rope1.render(pMatrixStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
		this.rope5.render(pMatrixStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
	}
