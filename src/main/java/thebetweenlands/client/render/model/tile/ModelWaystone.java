...
public class ModelWaystone extends Model {
	...
	public void renderToBuffer(MatrixStack matrix, IVertexBuilder vertex, int in1, int in2, float f, float f1, float f2, float f3) {  
		this.slate1.render(matrix, vertex, in1, in2, f, f1, f2, f3);
		this.rope1.render(matrix, vertex, in1, in2, f, f1, f2, f3);
		this.rope5.render(matrix, vertex, in1, in2, f, f1, f2, f3);
	}
