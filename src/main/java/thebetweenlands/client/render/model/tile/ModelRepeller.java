 ...
 */
public class ModelRepeller extends Model {
	...
	public ModelRepeller() {
		...
		this.pole3.setPos(0.0F, -6.0F, 0.0F);
		...
		this.pole5.setPos(0.0F, -6.0F, -2.0F);
		...
		this.jar_edge.setPos(0.0F, -1.0F, 0.0F);
		...
		this.jarbase.setPos(0.0F, 4.5F, -2.5F);
		...
		this.pole2.setPos(0.0F, -10.0F, -1.0F);
		...
		this.rope2.setPos(0.0F, 0.0F, 1.0F);
		...
		this.pole4.setPos(0.0F, -4.0F, 2.0F);
		...
		this.liquid.setPos(0.0F, 0.0F, 0.0F);
