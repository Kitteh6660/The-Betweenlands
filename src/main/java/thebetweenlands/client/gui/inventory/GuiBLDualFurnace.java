...
public class GuiBLDualFurnace extends GuiContainer {
    ...
    public GuiBLDualFurnace(PlayerInventory inventory, TileEntityBLDualFurnace tile) {
	...
	protected void drawGuiContainerForegroundLayer(int x, int y) {
        String s = tileFurnace.hasCustomName() ? tileFurnace.getName() : I18n.get(tileFurnace.getName(), new Object[0]);
        fontRenderer.drawString(s, xSize / 2 - fontRenderer.getStringWidth(s) / 2, 6, 4210752);
        fontRenderer.drawString(I18n.get("container.inventory", new Object[0]), 8, ySize - 96 + 2, 4210752);
    }
