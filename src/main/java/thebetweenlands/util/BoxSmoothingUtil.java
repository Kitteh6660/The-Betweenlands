...
public class BoxSmoothingUtil {
	...
	@Nullable
	public static Pair<Vector3d, Vector3d> findClosestSmoothPoint(List<AxisAlignedBB> boxes, float smoothingRange, float boxScale, float dx, int iters, float threshold, Vector3d p) {
		float px = 0.0f;
		float py = 0.0f;
		float pz = 0.0f;
