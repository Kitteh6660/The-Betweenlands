...
public class InputKey<T, R> implements IConfigurationInput {
	...
	private final IInputSerializer<?> serializer;

	@SuppressWarnings("unchecked")
	private InputKey(Class<?> type, boolean nullable, int index, boolean wildcard, String descriptor, boolean collection, IInputSerializer<?> serializer) {
	...
	private InputKey(Class<?>[] types, boolean nullable, int index, boolean wildcard, String descriptor, boolean collection, IInputSerializer<?> serializer) {
		this.type = null;
		this.types = types;
		this.nullable = nullable;
		this.index = index;
	...
	public static class Builder<T, R> {
		...
		private IInputSerializer<? super T> serializer;
		...
		public Builder<T, R> serializer(IInputSerializer<? super T> serializer) {
			this.serializer = serializer;
			return this;
		}
