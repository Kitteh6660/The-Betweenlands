...
//TODO: Maybe rework this file due to vanilla lanterns. Betweenlantern?
public class BetweenlanternBlock extends Block {
	
	private static final VoxelShape AABB_LARGE = Block.box(0.25D, 0.0D, 0.25D, 0.75D, 1.0D, 0.75D);
	private static final VoxelShape AABB_SMALL = Block.box(0.25D, 0.0D, 0.25D, 0.75D, 0.6D, 0.75D);
	
	public static final IntegerProperty ROTATION = IntegerProperty.create("rotation", 0, 7);
	public static final BooleanProperty HANGING = BooleanProperty.create("hanging");

	public BetweenlanternBlock(Properties properties) {
		super(properties);
		/*this.setHardness(0.1F);
		this.setCreativeTab(BLCreativeTabs.BLOCKS);
		this.setSoundType(soundType);
		this.setLightLevel(1.0f);*/
		this.registerDefaultState(this.defaultBlockState().setValue(ROTATION, 0).setValue(HANGING, false));
	}
