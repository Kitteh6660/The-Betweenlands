...
public class StagnantWaterFluid extends FlowingFluid implements IStateMappedBlock, ICustomItemBlock {
	
	/*public StagnantWaterFluid() {
	...
	public void setStateMapper(AdvancedStateMap.Builder builder) {
		builder.ignore(StagnantWaterFluid.LEVEL);
	}
