...
public class BlockDecayPitInvisibleFloorBlockDiagonal extends HorizontalFaceBlock implements ICustomItemBlock {
	...
	public BlockDecayPitInvisibleFloorBlockDiagonal(Properties properties) {
		super(properties);
		/*super(Material.ROCK);
		setHardness(10.0F);
	...
	protected void createBlockStateDefinition(StateContainer.Builder<Block, BlockState> state) {
		return new BlockStateContainer(this, new Property[] { FLIPPED });
	}

	public static final VoxelShape CORNER_NW_AABB = Block.box(0D, 0D, 0D, 0.25D, 1D, 0.25D);
	public static final VoxelShape CORNER_SW_AABB = Block.box(0D, 0D, 0.75D, 0.25D, 1D, 1D);
	public static final VoxelShape CORNER_NE_AABB = Block.box(0.75D, 0D, 0D, 1D, 1D, 0.25D);
	public static final VoxelShape CORNER_SE_AABB = Block.box(0.75D, 0D, 0.75D, 1D, 1D, 1D);

	public static final VoxelShape MID_NW_AABB = Block.box(0.25D, 0D, 0.25D, 0.5D, 1D, 0.5D);
	public static final VoxelShape MID_SW_AABB = Block.box(0.25D, 0D, 0.5D, 0.5D, 1D, 0.75D);
	public static final VoxelShape MID_NE_AABB = Block.box(0.5D, 0D, 0.25D, 0.75D, 1D, 0.5D);
	public static final VoxelShape MID_SE_AABB = Block.box(0.5D, 0D, 0.5D, 0.75D, 1D, 0.75D);
