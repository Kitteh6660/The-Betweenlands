...
public class BlockDecayPitInvisibleFloorBlockR1 extends HorizontalFaceBlock {

		public BlockDecayPitInvisibleFloorBlockR1(Properties properties) {
			super(properties);
			/*super(Material.ROCK);
			setHardness(10.0F);
    ...
    public static final VoxelShape BOX_S1 = Block.box(0D, 0D, 0D, 0.25D, 1D, 0.25D);
    public static final VoxelShape BOX_S2 = Block.box(0.25D, 0D, 0D, 0.5D, 1D, 0.3125D);
    public static final VoxelShape BOX_S3 = Block.box(0.5D, 0D, 0D, 0.75D, 1D, 0.375D);
    public static final VoxelShape BOX_S4 = Block.box(0.75D, 0D, 0D, 1D, 1D, 0.4375D);

    public static final VoxelShape BOX_N1 = Block.box(0D, 0D, 0.5625D, 0.25D, 1D, 1D);
    public static final VoxelShape BOX_N2 = Block.box(0.25D, 0D, 0.625D, 0.5D, 1D, 1D);
    public static final VoxelShape BOX_N3 = Block.box(0.5D, 0D, 0.6875D, 0.75D, 1D, 1D);
    public static final VoxelShape BOX_N4 = Block.box( 0.75, 0, 0.75, 1, 1, 1);

    public static final VoxelShape BOX_E1 = Block.box(0D, 0D, 0D, 0.4375D, 1D, 0.25D);
    public static final VoxelShape BOX_E2 = Block.box(0D, 0D, 0.25D, 0.375D, 1D, 0.5D);
    public static final VoxelShape BOX_E3 = Block.box(0D, 0D, 0.5D, 0.3125D, 1D, 0.75D);
    public static final VoxelShape BOX_E4 = Block.box(0, 0, 0.75, 0.25, 1, 1);

    public static final VoxelShape BOX_W1 = Block.box(0.75D, 0D, 0D, 1D, 1D, 0.25D);
    public static final VoxelShape BOX_W2 = Block.box(0.6875D, 0D, 0.25D, 1D, 1D, 0.5D);
    public static final VoxelShape BOX_W3 = Block.box(0.625D, 0D, 0.5D, 1D, 1D, 0.75D);
    public static final VoxelShape BOX_W4 = Block.box(0.5625D, 0D, 0.75D, 1D, 1D, 1D);
