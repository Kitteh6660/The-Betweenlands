...
public class SapTree extends Tree {
	...
	public boolean generate(World world, Random rand, BlockPos pos) {
		...
		this.logX = BlockRegistry.LOG_SAP.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Axis.X);
		this.logY = BlockRegistry.LOG_SAP.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Axis.Y);
		this.logZ = BlockRegistry.LOG_SAP.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Axis.Z);
		this.roots = BlockRegistry.LOG_SAP.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Axis.NONE);
		this.leaves = BlockRegistry.LEAVES_SAP_TREE.get().defaultBlockState().setValue(BlockLeavesBetweenlands.PERSISTENT, false);
