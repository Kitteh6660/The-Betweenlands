...
public class WorldGenSmallRuins extends WorldGenHelper {
	...
	private static final BlockState ANGRY_BETWEENSTONE = BlockRegistry.ANGRY_BETWEENSTONE.defaultBlockState();
	private static final BlockState BETWEENSTONE_TILES = BlockRegistry.BETWEENSTONE_TILES.defaultBlockState();
	...
	public WorldGenSmallRuins(){
		super(BlockRegistry.MUD.defaultBlockState(), BlockRegistry.SWAMP_GRASS.defaultBlockState());
	...
	private boolean structure1(World world, Random random, int x, int y, int z, boolean doGen, LocationStorage location) {
		...
		if (doGen) {
			...
			rotatedLootPot(world, random, x, y, z, 4, height - 2, 0, direction, 1, 2, 5, LootTableRegistry.MARSH_RUINS_POT);
		}
		return true;
	}
	...
	private boolean structure2(World world, Random random, int x, int y, int z, boolean doGen, LocationStorage location) {
		...
		if (doGen) {
			...
			if (random.nextInt(5) == 0) {
				...
				rotatedLootPot(world, random, x, y, z, 0, height, 0, direction, 1, 2, 1, LootTableRegistry.MARSH_RUINS_POT);
			}
		}
		return true;
	}
	...
	private boolean structure3(World world, Random random, int x, int y, int z, boolean doGen, LocationStorage location) {
		...
		if (doGen) {
			...
			rotatedLootPot(world, random, x, y, z, 2, 6, 0, direction, 1, 2, 5, LootTableRegistry.MARSH_RUINS_POT);
			rotatedLootPot(world, random, x, y, z, 6, 6, 0, direction, 1, 2, 5, LootTableRegistry.MARSH_RUINS_POT);
			rotatedLootPot(world, random, x, y, z, 2, 6, 4, direction, 1, 2, 5, LootTableRegistry.MARSH_RUINS_POT);
			rotatedLootPot(world, random, x, y, z, 6, 6, 4, direction, 1, 2, 5, LootTableRegistry.MARSH_RUINS_POT);
		}
		return true;
	}
	...
	private boolean structure5(World world, Random random, int x, int y, int z, boolean doGen, LocationStorage location) {
		...
		if (doGen) {
			...
			rotatedLootPot(world, random, x, y, z, 0, height, 0, direction, 1, 2, 5, LootTableRegistry.MARSH_RUINS_POT);
		}
		return true;
	}
	...
	private boolean structure6(World world, Random random, int x, int y, int z, boolean doGen, LocationStorage location) {
		...
		if (doGen) {
			...
			rotatedLootPot(world, random, x, y, z, 0, 1, 0, direction, 1, 2, 5, LootTableRegistry.MARSH_RUINS_POT);
			rotatedLootPot(world, random, x, y, z, width - 1, 1, 0, direction, 1, 2, 5, LootTableRegistry.MARSH_RUINS_POT);
	...
	private boolean structure7(World world, Random random, int x, int y, int z, boolean doGen, LocationStorage location) {
		...
		if (doGen) {
			...
			rotatedLootPot(world, random, x, y, z, 9, 1, 6, direction, 1, 2, 1, LootTableRegistry.MARSH_RUINS_POT);
			...
			rotatedLootPot(world, random, x, y, z, 9, 1, 9, direction, 1, 2, 1, LootTableRegistry.MARSH_RUINS_POT);
	...
	private void generateLoot(World world, Random random, int x, int y, int z) {
		world.setBlockState(new BlockPos(x, y, z), getRandomBlock(random, Direction.byHorizontalIndex(random.nextInt(4))), 2);
		TileEntityLootPot lootPot = BlockLootPot.getBlockEntity(world, new BlockPos(x, y, z));
		if (lootPot != null) {
			lootPot.setLootTable(LootTableRegistry.MARSH_RUINS_POT, random.nextLong());
		}
	}

	private BlockState getRandomBlock(Random rand, Direction dir) {
		switch (rand.nextInt(3)) {
		case 0:
			return BlockRegistry.LOOT_POT.defaultBlockState().setValue(BlockLootPot.VARIANT, EnumLootPot.POT_1).setValue(BlockLootPot.FACING, dir);
		case 1:
			return BlockRegistry.LOOT_POT.defaultBlockState().setValue(BlockLootPot.VARIANT, EnumLootPot.POT_2).setValue(BlockLootPot.FACING, dir);
		case 2:
			return BlockRegistry.LOOT_POT.defaultBlockState().setValue(BlockLootPot.VARIANT, EnumLootPot.POT_3).setValue(BlockLootPot.FACING, dir);
		default:
			return BlockRegistry.LOOT_POT.defaultBlockState().setValue(BlockLootPot.VARIANT, EnumLootPot.POT_1).setValue(BlockLootPot.FACING, dir);
		}
	}
