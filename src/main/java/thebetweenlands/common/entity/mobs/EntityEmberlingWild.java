...
public class EntityEmberlingWild extends MobEntity implements IEntityMultiPart, IEntityBL{
	...
	public boolean getCanSpawnHere() {
		BlockState iblockstate = this.world.getBlockState((new BlockPos(this)).below());
		return iblockstate.canEntitySpawn(this) && level.getDifficulty() != EnumDifficulty.PEACEFUL;
	}
