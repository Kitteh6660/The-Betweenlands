...
public class BLFoods
{
    ...
    public static final Food GERTS_DONUT = new ItemGertsDonut();
    ...
    public static final Food WEEPING_BLUE_PETAL = new ItemWeepingBluePetal();
    ...
    public static final Food NETTLE_SOUP = new ItemNettleSoup();
    ...
    public static final Food BLACK_HAT_MUSHROOM_ITEM = (new Food.Builder()).nutrition(3).saturationMod(0.6F).effect(() -> new EffectInstance(Effects.HUNGER, 500, 1), 1.0F).build(); // new ItemBlackHatMushroom();
    public static final Food BULB_CAPPED_MUSHROOM_ITEM = (new Food.Builder()).nutrition(3).saturationMod(0.6F).effect(() -> new EffectInstance(Effects.CONFUSION, 200, 0), 1.0F).effect(() -> new EffectInstance(Effects.NIGHT_VISION, 200, 0), 1.0F).build(); // new ItemBulbCappedMushroom();
    public static final Food SWAMP_REED_ITEM = new ItemSwampReed();
    public static final Food SWAMP_KELP_ITEM = new ItemSwampKelp();
    ...
    public static final Food CHIROMAW_WING = new ItemChiromawWing();
    ...
    public static final Food WEEPING_BLUE_PETAL_SALAD = new ItemWeepingBluePetalSalad();
    public static final Food NIBBLESTICK = new ItemNibblestick();
