...
public class BLSwordItem extends SwordItem implements ICorrodible, IAnimatorRepairable {
	
	public BLSwordItem(IItemTier itemTier, int damage, float speed, Properties properties) {
		super(itemTier, damage, speed, properties);
		//this.toolMaterial = itemTier;
	...
	public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot, ItemStack stack) {
		return CorrosionHelper.getAttributeModifiers(super.getAttributeModifiers(slot, stack), slot, stack, BASE_ATTACK_DAMAGE_UUID, 3.0F + this.getDamage());
	}
