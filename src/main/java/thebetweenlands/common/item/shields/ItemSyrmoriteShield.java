...
public class ItemSyrmoriteShield extends ItemSwatShield {
	...
	public void appendHoverText(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		tooltip.addAll(ItemTooltipHandler.splitTooltip(I18n.get("tooltip.bl.syrmorite_shield", Minecraft.getInstance().gameSettings.keyBindSneak.getDisplayName(), Minecraft.getInstance().gameSettings.keyBindUseItem.getDisplayName()), 0));
	}
}
