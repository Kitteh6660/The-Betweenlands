...
public class ElixirEffectRegistry {
	//Elixirs
	public static final ElixirEffect EFFECT_STRENGTH = new ElixirEffect(0, "bl.elixir.strength", new ResourceLocation("thebetweenlands:textures/items/strictly_herblore/misc/vial_green.png")).addAttributeModifier(Attributes.ATTACK_DAMAGE, "241751b1-7e4c-409a-bc66-70ce1330b6f6", 3.5D, 0).setShowInBook();
	public static final ElixirEffect EFFECT_NIMBLEFEET = new ElixirEffect(1, "bl.elixir.nimblefeet", new ResourceLocation("thebetweenlands:textures/items/strictly_herblore/misc/vial_green.png")).addAttributeModifier(Attributes.MOVEMENT_SPEED, "645a98a2-7bfd-11e5-8bcf-feff819cdc9f", 0.2D, 2).setShowInBook();
	...
	//Anti Elixirs
	public static final ElixirEffect EFFECT_WEAKNESS = new ElixirEffect(17, "bl.elixir.weakness", new ResourceLocation("thebetweenlands:textures/items/strictly_herblore/misc/vial_green.png")).addAttributeModifier(Attributes.ATTACK_DAMAGE, "886d753c-fcf2-4370-99b3-eb8e4fbaabcf", -2.0D, 0).setAntiInfusion().setShowInBook();
	public static final ElixirEffect EFFECT_LUMBERING = new ElixirEffect(18, "bl.elixir.lumbering", new ResourceLocation("thebetweenlands:textures/items/strictly_herblore/misc/vial_green.png")).addAttributeModifier(Attributes.MOVEMENT_SPEED, "2c06470c-b549-47e9-893c-0d9950c77716", -0.2D, 2).setAntiInfusion().setShowInBook();
	...
	//Potions
	public static final Effect ROOT_BOUND = new PotionRootBound();
	public static final Effect ENLIGHTENED = new PotionEnlightened();
	...
	@SubscribeEvent
	public static void registerElixirs(final RegistryEvent.Register<Effect> event) {
